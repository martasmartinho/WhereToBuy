...
CREATE TABLE [dbo].[tmp_ms_xx_Categorias] (
    ...
    [PrecoMinimoPermitido] DECIMAL (14, 4) NULL,
    [PrecoMaximoPermitido] DECIMAL (14, 4) NULL,
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Categorias])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Categorias] ([Codigo], [Descricao], [PesoMedioUnidade], [PrecoAmplitudeMax], [Inativo], [Criacao], [Versao])
        SELECT   [Codigo],
                 [Descricao],
                 [PesoMedioUnidade],
                 [PrecoAmplitudeMax],
