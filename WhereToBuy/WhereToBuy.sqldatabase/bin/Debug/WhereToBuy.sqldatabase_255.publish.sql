...
GO
PRINT N'Dropping [dbo].[CotacoesIncompletasNormalizacaoView]...';


GO
DROP VIEW [dbo].[CotacoesIncompletasNormalizacaoView];


GO
PRINT N'Dropping [dbo].[GetCotacaoValidadeFunction]...';


GO
DROP FUNCTION [dbo].[GetCotacaoValidadeFunction];
...
BEGIN
	...
	BEGIN
		...
		SET @formula = 'validade = (definida fornecida pelo fornecedor)';
