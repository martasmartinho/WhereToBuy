...
GO
PRINT N'Altering [dbo].[Step4b3_OutOfInterval_Notifications]...';
...
ALTER PROCEDURE [dbo].[Step4b3_OutOfInterval_Notifications]
...
AS
	...
	BEGIN TRY
		...
		*/
		...
		SELECT NEWID(), 
			   ...
			   'IAPD' AS AvisoTipoCodigo,
			   '!Prevenção[Preço Desfazado] (' + CONVERT(varchar, GETDATE(), 103) + ') Preço fora do intervalo ' +
		...
		SET @Info = '[Step4b3_OutOfInterval_Notifications-01] Number of inserted notifications: ' + CAST(@@ROWCOUNT as nvarchar);
	...
	BEGIN CATCH
		...
		SET @Info = '[Step4b3_OutOfInterval_Notifications-02] ' + CAST(ERROR_NUMBER() as nvarchar) + ' - ' + ERROR_MESSAGE();
