...
BEGIN	
	INSERT INTO [dbo].[Impostos] ([Codigo], [Descricao], [DesignacaoFiscal], [Taxa], [Inativo], [Criacao])
		VALUES ('IVA.PTC.N23', 'Iva Portugal Continental (taxa normal 23%)', 'Iva PT.Continental 23%', 23.255, GETDATE(), GETDATE())
END
GO
