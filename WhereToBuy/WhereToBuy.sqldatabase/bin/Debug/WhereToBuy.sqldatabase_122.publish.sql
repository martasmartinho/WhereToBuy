...
GO
ALTER TABLE [dbo].[CotacoesAvisos] ALTER COLUMN [_ComplementoCodigo] NVARCHAR (128) NOT NULL;

ALTER TABLE [dbo].[CotacoesAvisos] ALTER COLUMN [_ProdutoCodigo] NVARCHAR (256) NOT NULL;
...
ALTER TABLE [dbo].[CotacoesAvisos]
    ADD CONSTRAINT [UC_CotacoesAvisos] UNIQUE NONCLUSTERED ([Data] ASC, [_ProdutoCodigo] ASC, [_ComplementoCodigo] ASC);
