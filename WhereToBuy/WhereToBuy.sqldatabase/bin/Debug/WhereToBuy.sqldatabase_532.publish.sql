...
GO
PRINT N'Altering [dbo].[ProductMatchingSelect]...';


GO
ALTER PROCEDURE [dbo].[ProductMatchingSelect]
...
AS
	...
	SET @select = 'SELECT m.[FornecedorCodigo], f.[Nome] as FornecedorNome, m.[Codigo], m.[ComplementoCodigo],
							m.[Descricao], m.[HorasValidadeCotacao], m.[StockCodigoSubstituto], s.[Descricao] as StockDescricao,
							m.[DispensaPrevencaoPrecosDesfasados],  m.[DispensaPrevencaoPrecosDesfasados],
							m.[DataReset], m.[MapTo], p.[Descricao] as ProdutoDescricao, m.[Inativo], m.[Criacao], m.[Versao]				
