...
ALTER PROCEDURE [dbo].[CotacaoInsertSP]
	...
	@Info nvarchar(128) OUTPUT
AS

	-- variaveis
	DECLARE @Erro nvarchar(255), @Partnumber nvarchar(25);
	...
	BEGIN
		-- disparar um erro
		SET @info = '[CotacaoInsertSP-99] (StoredProcedure)' + 'o valor do parametro @_Preco está em teste.. bla bla bla whiscas saquetas!';
		RETURN 0;
		--SET @Erro = '[CotacaoInsertSP-99] (StoredProcedure)' + 'o valor do parametro @_Preco está em teste.. bla bla bla whiscas saquetas!';
		--RAISERROR (@Erro, 15, 1)
		--RETURN 0;
	END
	SET @info = 'Registo inserido corretamente!';
