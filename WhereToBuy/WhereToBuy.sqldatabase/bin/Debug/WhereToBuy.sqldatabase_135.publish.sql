...
GO
PRINT N'Creating [dbo].[Step2b1b_Mappings_Impostos_Map]...';
...
CREATE PROCEDURE [dbo].[Step2b1b_Mappings_Impostos_Map]
...
AS
	...
	BEGIN TRY
		...
		*/
		...
		SET @Info = '[Step2b1b_Mappings_Impostos_Map-01] Number of mapped quotations: ' + CAST(@@ROWCOUNT as nvarchar);
	...
	BEGIN CATCH
		...
		SET @Info = '[Step2b1b_Mappings_Impostos_Map-02] ' + CAST(ERROR_NUMBER() as nvarchar) + ' - ' + ERROR_MESSAGE();
