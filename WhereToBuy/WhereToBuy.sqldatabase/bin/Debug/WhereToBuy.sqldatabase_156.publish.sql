...
GO
PRINT N'Altering [dbo].[GetTextoStrippedFunction]...';
...
/*
	...
	Example of use:
	SELECT [dbo].GetTextoStrippedFunction('Th.-is is the t-es+t num$ber 93!','[A-Za-z0-9 ]');
*/

ALTER FUNCTION [dbo].GetTextoStrippedFunction
(
	@texto nvarchar(256),
...
BEGIN
	...
	-- variaveis
	DECLARE @i AS INTEGER = 0, @result nvarchar(256) = '';

	-- percorrer cada caracter e concatenar apenas os caracteres permitidos
	WHILE @i < LEN(@texto)
	BEGIN
		
		-- se o caracter atual for válido na expressão regular
