...
AS
	...
	BEGIN TRY
		...
		*/
		...
		SET @Info = '[Step4a1_Preparation_Notifications-01] Number of inserted notifications: ' + CAST(@@ROWCOUNT as nvarchar);
...
GO
/*
	Update Quotations information that must be changed due to ProdutosMatching or CotacoesRegras update rules.
	This SP uses CotacoesAtuaisRecalcular to simply the process.
*/
...
AS
	...
	BEGIN TRY
		...
		/*
			Update values of quotation fields, as needed
		*/



		-- fill output @info with sucess message
		SET @Info = '[Step4a1_Preparation_OtherFieldsRefresh-01] Number of Other Fields Refreshed: ' + CAST(@@ROWCOUNT as nvarchar);
