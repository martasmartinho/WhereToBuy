...
GO
PRINT N'Creating [dbo].[Step2b1a_Mappings_Status_FeedNewRules]...';


GO
/*
	This SP feeds Status Matching table with new rules, considering the new incoming quotations
*/


CREATE PROCEDURE [dbo].[Step2b1a_Mappings_Status_FeedNewRules]
...
AS
	...
	BEGIN TRY
		...
		*/
		...
		SET @Info = '[Step2b1a_Mappings_Status_FeedNewRules-01] Number of created matching rules: ' + CAST(@@ROWCOUNT as nvarchar);
	...
	BEGIN CATCH
		...
		SET @Info = '[Step2b1a_Mappings_Status_FeedNewRules-02] ' + CAST(ERROR_NUMBER() as nvarchar) + ' - ' + ERROR_MESSAGE();
