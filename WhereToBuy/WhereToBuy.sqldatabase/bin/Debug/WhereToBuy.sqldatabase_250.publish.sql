...
GO
PRINT N'Creating [dbo].[Step2b1z_QuotationsRules_FeedNewRules]...';
...
CREATE PROCEDURE [dbo].[Step2b1z_QuotationsRules_FeedNewRules]
...
AS
	...
	BEGIN TRY
		...
		*/
		...
		SET @Info = '[Step2b1z_QuotationsRules_FeedNewRules-01] Number of created matching rules: ' + CAST(@@ROWCOUNT as nvarchar);
