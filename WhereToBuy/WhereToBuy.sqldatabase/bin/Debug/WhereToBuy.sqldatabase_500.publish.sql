...
AS
	...
	SET @select = 'SELECT produtos.[Codigo], produtos.[Descricao], produtos.[Partnumber], 
							produtos.[CategoriaCodigo], categorias.[Descricao] as CategoriaDescricao,
							produtos.[MarcaCodigo], marcas.[Descricao] as MarcaDescricao,
							produtos.[ImpostoCodigo], impostos.[Descricao] as ImpostoDescricao, impostos.[DesignacaoFiscal] as DesignacaoFiscal,
							produtos.[FornecedorCodigo], fornecedores.[Nome] as FonecedorNome, 
							pDetalhes.[AtualizacaoManualNecessaria], pDetalhes.[IndicePreocupacaoConteudo],
							produtos.[PrecoCusto], produtos.[PrecoCusto_Data], 
							produtos.[PrecoCusto_U1], produtos.[PrecoCusto_U1Data], 
							produtos.[PrecoCusto_U2], produtos.[PrecoCusto_U2Data], 
							produtos.[PrecoCusto_U3], produtos.[PrecoCusto_U3Data], 
							produtos.[StockCodigo], stocks.[Descricao],produtos.[StockCodigo_Data], 
							produtos.[StockCodigo_U1], stocksU1.[Descricao], produtos.[StockCodigo_U1Data], 
							produtos.[StockCodigo_U2], stocksU2.[Descricao], produtos.[StockCodigo_U2Data], 
							produtos.[StockCodigo_U3], stocksU3.[Descricao],produtos.[StockCodigo_U3Data], 
							produtos.[Descontinuado], produtos.[Inativo], 
							produtos.[Criacao], produtos.[Versao]
						FROM [dbo].[Produtos] produtos
						LEFT JOIN  [dbo].[Categorias] categorias
							ON categorias.[Codigo] = produtos.[CategoriaCodigo]
						LEFT JOIN  [dbo].[Marcas] marcas
							ON marcas.[Codigo] = produtos.[MarcaCodigo]
						LEFT JOIN  [dbo].[Impostos] impostos
							ON impostos.[Codigo] = produtos.[ImpostoCodigo]
						LEFT JOIN  [dbo].[Fornecedores] fornecedores
							ON fornecedores.[Codigo] = produtos.[FornecedorCodigo]
						LEFT JOIN  [dbo].[ProdutosDetalhe] pDetalhes
							ON pDetalhes.[ProdutoCodigo] = produtos.[Codigo] AND pDetalhes.[FornecedorCodigo] = produtos.[FornecedorCodigo]
						LEFT JOIN  [dbo].[Stocks] stocks
							ON stocks.[Codigo] = produtos.[StockCodigo]
						LEFT JOIN  [dbo].[Stocks] stocksU1
							ON stocksU1.[Codigo] = produtos.[StockCodigo_U1]
						LEFT JOIN  [dbo].[Stocks] stocksU2
							ON stocksU2.[Codigo] = produtos.[StockCodigo_U2]
						LEFT JOIN  [dbo].[Stocks] stocksU3
							ON stocksU3.[Codigo] = produtos.[StockCodigo_U3]'
...
GO
ALTER TABLE [dbo].[Utilizadores] WITH CHECK CHECK CONSTRAINT [FK_Utilizador_Idioma];
