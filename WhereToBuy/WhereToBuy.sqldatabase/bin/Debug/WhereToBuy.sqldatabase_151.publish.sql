...
GO
PRINT N'Altering [dbo].[Step2b1c_Mappings_Addons_Notifications]...';
...
ALTER PROCEDURE [dbo].[Step2b1c_Mappings_Addons_Notifications]
...
RETURN;
GO
PRINT N'Creating [dbo].[Step2b1c_Mappings_Status_Notifications]...';
...
CREATE PROCEDURE [dbo].[Step2b1c_Mappings_Status_Notifications]
	@Info nvarchar(256) OUTPUT
AS
	...
	BEGIN TRY
		...
		*/
		...
		-- fill output @info with sucess message
		SET @Info = '[Step2b1c_Mappings_Status_Notifications-01] Number of inserted notifications: ' + CAST(@@ROWCOUNT as nvarchar);
	...
	BEGIN CATCH
		-- fill output @info with occurred error message
		SET @Info = '[Step2b1c_Mappings_Status_Notifications-02] ' + CAST(ERROR_NUMBER() as nvarchar) + ' - ' + ERROR_MESSAGE();
