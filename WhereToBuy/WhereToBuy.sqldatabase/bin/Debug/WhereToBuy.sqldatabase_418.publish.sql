...
RETURN;
GO
PRINT N'Creating [dbo].[Step1a1_DeleteNotIntegratedExistingQuotations]...';
...
CREATE PROCEDURE [dbo].[Step1a1_DeleteNotIntegratedExistingQuotations]
	@FornecedorCodigo nvarchar(20),
	@Info nvarchar(256) OUTPUT
AS
	...
	BEGIN TRY
		...
		SET @Info = '[Step1a1_DeleteNotIntegratedExistingQuotations-01] Were removed sucessfully, ' + CAST(@@ROWCOUNT as nvarchar) + ' not integrated quotations of the supplier ' + @FornecedorCodigo +'.';
	...
	BEGIN CATCH
		...
		SET @Info = '[Step1a1_DeleteNotIntegratedExistingQuotations-02] ' + CAST(ERROR_NUMBER() as nvarchar) + ' - ' + ERROR_MESSAGE();
...
RETURN;
GO
PRINT N'Creating [dbo].[Step2a3_Preparation_SetInactiveExpiredQuotations]...';
...
CREATE PROCEDURE [dbo].[Step2a3_Preparation_SetInactiveExpiredQuotations]
	@Info nvarchar(256) OUTPUT
AS
	...
	BEGIN TRY
		...
		-- fill output @info with sucess message
		SET @Info = '[Step2a3_Preparation_SetInactiveExpiredQuotations-01] Inativação de quotações expiradas realizada com sucesso';
	...
	BEGIN CATCH
		-- fill output @info with occurred error message
		SET @Info = '[Step2a3_Preparation_SetInactiveExpiredQuotations-02] ' + CAST(ERROR_NUMBER() as nvarchar) + ' - ' + ERROR_MESSAGE();
...
RETURN;
GO
PRINT N'Creating [dbo].[Step3c1_Finishing_ProductDescontinuation]...';
...
CREATE PROCEDURE [dbo].[Step3c1_Finishing_ProductDescontinuation]
	@Info nvarchar(256) OUTPUT
AS
	...
	BEGIN TRY
		...
		*/
		...
		-- fill output @info with sucess message
		SET @Info = '[Step3c1_Finishing_ProductDescontinuation-01] Number of Descontinued Products: ' + CAST(@@ROWCOUNT as nvarchar);
	...
	BEGIN CATCH
		-- fill output @info with occurred error message
		SET @Info = '[Step3c1_Finishing_ProductDescontinuation-02] ' + CAST(ERROR_NUMBER() as nvarchar) + ' - ' + ERROR_MESSAGE();
...
RETURN;
GO
PRINT N'Creating [dbo].[Step3c2_Finishing_ProductResurrection]...';
...
CREATE PROCEDURE [dbo].[Step3c2_Finishing_ProductResurrection]
	@Info nvarchar(256) OUTPUT
AS
	...
	BEGIN TRY
		...
		*/
		...
		-- fill output @info with sucess message
		SET @Info = '[Step3c2_Finishing_ProductResurrection-01] Number of Resurrected Products: ' + CAST(@@ROWCOUNT as nvarchar);
	...
	BEGIN CATCH
		-- fill output @info with occurred error message
		SET @Info = '[Step3c2_Finishing_ProductResurrection-02] ' + CAST(ERROR_NUMBER() as nvarchar) + ' - ' + ERROR_MESSAGE();
