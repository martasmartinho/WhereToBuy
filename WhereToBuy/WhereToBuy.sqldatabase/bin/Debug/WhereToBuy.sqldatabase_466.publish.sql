...
GO
PRINT N'Altering [dbo].[StateCount]...';


GO
ALTER PROCEDURE [dbo].[StateCount]
...
GO
PRINT N'Altering [dbo].[StateDelete]...';


GO
ALTER PROCEDURE [dbo].[StateDelete]
	@Codigo nvarchar(5),
	@Versao datetime
AS
...
AS
	...
	END CATCH
GO
PRINT N'Altering [dbo].[StateSelect]...';


GO
ALTER PROCEDURE [dbo].[StateSelect]
