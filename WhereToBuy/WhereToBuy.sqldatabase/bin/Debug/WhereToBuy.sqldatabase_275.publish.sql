...
GO
PRINT N'Altering [dbo].[Step3b1_Promotion_PromoteQuotations]...';
...
ALTER PROCEDURE [dbo].[Step3b1_Promotion_PromoteQuotations]
	...
	BEGIN TRANSACTION
		...
		BEGIN TRY
			...
			*/
			...
			SET @Info = '[Step3b1_Promotion_PromoteQuotations-01] Number of disabled Actual Quotations: ' + CAST(@@ROWCOUNT as nvarchar);
			...
			*/
			...
			-- fill output @info with sucess message
			SET @Info += '; Number of promoted Quotations: ' + CAST(@@ROWCOUNT as nvarchar);
