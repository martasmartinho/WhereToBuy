	...
	BEGIN TRANSACTION
		...
		BEGIN TRY
			...
			*/
			...
			SET @Info = '[Step3b1_Promotion_PromoteQuotations-01] Number of Actual Quotations Disabled: ' + CAST(@@ROWCOUNT as nvarchar);
			...
			*/
			...
			-- fill output @info with sucess message
			SET @Info += '; ';
			SET @Info += '[Step3b1_Promotion_PromoteQuotations-02] Number of Quotations promoted to Integrated status: ' + CAST(@@ROWCOUNT as nvarchar);
		...
		BEGIN CATCH
			...
			SET @Info = '[Step3b1_Promotion_PromoteQuotations-03] ' + CAST(ERROR_NUMBER() as nvarchar) + ' - ' + ERROR_MESSAGE();
