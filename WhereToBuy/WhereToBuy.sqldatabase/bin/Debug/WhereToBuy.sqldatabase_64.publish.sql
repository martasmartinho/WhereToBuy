...
GO
PRINT N'Altering [dbo].[Cotacoes]...';


GO
ALTER TABLE [dbo].[Cotacoes] ALTER COLUMN [_CategoriaCodigo] NVARCHAR (128) NOT NULL;

ALTER TABLE [dbo].[Cotacoes] ALTER COLUMN [_CategoriaDescricao] NVARCHAR (128) NOT NULL;
