...
GO
/*
	This function receives the original Partnumber sended by the supplier and minimize it to only kepp the principal chars.
	...
	process only undesirable chars were cleaned, now, with this function, the cleaned partnumber is reduced to the minimum of representative chars
...
(
	@externalPartnumber nvarchar(25)
)
RETURNS nvarchar(25)
AS
BEGIN
	...
	-- variables
	DECLARE @minimizedPartnumber AS NVARCHAR(25);

	-- minimize received Partnumber to the minimum of representative chars
	SET @minimizedPartnumber = [dbo].GetTextoOnlyAllowedCharsFunction(@externalPartnumber,'[A-Za-z0-9]');
