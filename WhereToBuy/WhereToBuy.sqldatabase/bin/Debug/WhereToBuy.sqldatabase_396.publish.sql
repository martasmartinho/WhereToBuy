...
GO
PRINT N'Altering [dbo].[Step4b5_IrregularAmplitude_Notifications]...';
...
ALTER PROCEDURE [dbo].[Step4b5_IrregularAmplitude_Notifications]
...
RETURN;
GO
PRINT N'Creating [dbo].[Step4b6_IrregularAmplitude_Execution]...';
...
CREATE PROCEDURE [dbo].[Step4b6_IrregularAmplitude_Execution]
	@Info nvarchar(256) OUTPUT
AS
	...
	BEGIN TRY
		...
		*/
		...
		-- fill output @info with sucess message
		SET @Info = '[Step4b6_IrregularAmplitude_Execution-01] Number of executed Irregular Amplitude preventions: ' + CAST(@@ROWCOUNT as nvarchar);
	...
	BEGIN CATCH
		-- fill output @info with occurred error message
		SET @Info = '[Step4b6_IrregularAmplitude_Execution-02] ' + CAST(ERROR_NUMBER() as nvarchar) + ' - ' + ERROR_MESSAGE();
