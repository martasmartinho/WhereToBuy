...
GO
PRINT N'Creating [dbo].[Step2b1c_Mappings_Impostos_Notifications]...';
...
CREATE PROCEDURE [dbo].[Step2b1c_Mappings_Impostos_Notifications]
...
AS
	...
	BEGIN TRY
		...
		*/
		...
		SET @Info = '[Step2b1c_Mappings_Impostos_Notifications-01] Number of inserted notifications: ' + CAST(@@ROWCOUNT as nvarchar);
	...
	BEGIN CATCH
		...
		SET @Info = '[Step2b1c_Mappings_Impostos_Notifications-02] ' + CAST(ERROR_NUMBER() as nvarchar) + ' - ' + ERROR_MESSAGE();
