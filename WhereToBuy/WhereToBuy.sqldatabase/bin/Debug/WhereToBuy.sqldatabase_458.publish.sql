...
AS
	...
	SET @select = 'SELECT cotacoesAvisos.[Id], cotacoesAvisos.[Data], cotacoesAvisos.[_ProdutoCodigo], 
							cotacoesAvisos.[_ComplementoCodigo], cotacoesAvisos.[FornecedorCodigo], 
							cotacoesAvisos.[AvisoTipoCodigo], cotacoesAvisos.[Descricao], cotacoesAvisos.[Criacao]				
						FROM [dbo].[CotacoesAvisos] cotacoesAvisos' 
