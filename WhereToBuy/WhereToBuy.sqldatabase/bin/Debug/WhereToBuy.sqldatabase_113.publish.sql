...
GO
PRINT N'Altering [dbo].[DeleteIncompleteExistingQuotations]...';
...
ALTER PROCEDURE [dbo].[DeleteIncompleteExistingQuotations]
...
AS
	...
	BEGIN TRY
		...
		SET @Info = '[DeleteIncompleteExistingQuotations-01] Foram removidas ' + CAST(@@ROWCOUNT as nvarchar) + ' cotações incompletas do fornecedor especificado com sucesso'
