...
CREATE VIEW [dbo].[CotacoesAtuaisPrecosForaIntervaloView]
	...
	WHERE (c.PrecoCusto < t.PrecoMinimoPermitido OR c.PrecoCusto > t.PrecoMaximoPermitido)
		  AND m.DispensaPrevencaoPrecosDesfazados = CAST('false' as bit)
GO
PRINT N'Creating [dbo].[Step4b3_OutOfInterval_Notifications]...';
...
CREATE PROCEDURE [dbo].[Step4b3_OutOfInterval_Notifications]
