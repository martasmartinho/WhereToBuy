...
GO
PRINT N'Altering [dbo].[Step2a_CleanAllExistingWarnings]...';
...
ALTER PROCEDURE [dbo].[Step2a_CleanAllExistingWarnings]
...
AS
	...
	BEGIN TRY
		...
		SET @Info = '[Step2a_CleanAllExistingWarnings-01] Limpeza com sucesso da tabela CotacoesAvisos';
	...
	BEGIN CATCH
		...
		SET @Info = '[Step2a_CleanAllExistingWarnings-02] ' + CAST(ERROR_NUMBER() as nvarchar) + ' - ' +ERROR_MESSAGE();
