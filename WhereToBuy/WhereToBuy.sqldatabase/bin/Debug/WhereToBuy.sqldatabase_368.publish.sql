...
GO
PRINT N'Creating [dbo].[Step4a4_Precautions_FakeStock]...';
...
CREATE PROCEDURE [dbo].[Step4a4_Precautions_FakeStock]
...
AS
	...
	BEGIN TRY
		...
		*/
		...
		SET @Info = '[Step4a4_Precautions_FakeStock-01] Number of executed FakeStock preventions: ' + CAST(@@ROWCOUNT as nvarchar);
	...
	BEGIN CATCH
		...
		SET @Info = '[Step4a4_Precautions_FakeStock-02] ' + CAST(ERROR_NUMBER() as nvarchar) + ' - ' + ERROR_MESSAGE();
