...
GO
PRINT N'Altering [dbo].[SupplementCount]...';


GO
ALTER PROCEDURE [dbo].[SupplementCount]
...
GO
PRINT N'Altering [dbo].[SupplementDelete]...';


GO
ALTER PROCEDURE [dbo].[SupplementDelete]
	@Codigo nvarchar(5),
	@Versao datetime
AS
...
AS
	...
	END CATCH
GO
PRINT N'Altering [dbo].[SupplementSelect]...';


GO
ALTER PROCEDURE [dbo].[SupplementSelect]
