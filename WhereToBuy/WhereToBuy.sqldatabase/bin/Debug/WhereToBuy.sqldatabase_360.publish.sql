...
GO
PRINT N'Altering [dbo].[Step4a3_Precautions_FakeStock]...';
...
ALTER PROCEDURE [dbo].[Step4a3_Precautions_FakeStock]
...
UPDATE c
		SET StockCodigoSubstitutoJustificacao =
				CASE WHEN (GETDATE() >= c.P90) AND (s.ValidadeP90_StockCodigo IS NOT NULL) THEN 
					 ...
					 WHEN (GETDATE() >= c.P80) AND (s.ValidadeP80_StockCodigo IS NOT NULL) THEN
					 ...
					 WHEN (GETDATE() >= c.P70) AND (s.ValidadeP70_StockCodigo IS NOT NULL) THEN
					 ...
					 WHEN (GETDATE() >= c.P60) AND (s.ValidadeP60_StockCodigo IS NOT NULL) THEN
					 ...
					 WHEN (GETDATE() >= c.P50) AND (s.ValidadeP50_StockCodigo IS NOT NULL) THEN
			...
			StockCodigoSubstituto =
				CASE WHEN (GETDATE() >= c.P90) AND (s.ValidadeP90_StockCodigo IS NOT NULL) THEN 
								s.ValidadeP90_StockCodigo

					 WHEN (GETDATE() >= c.P80) AND (s.ValidadeP80_StockCodigo IS NOT NULL) THEN 
								s.ValidadeP80_StockCodigo

					 WHEN (GETDATE() >= c.P70) AND (s.ValidadeP70_StockCodigo IS NOT NULL) THEN 
								s.ValidadeP70_StockCodigo

					 WHEN (GETDATE() >= c.P60) AND (s.ValidadeP60_StockCodigo IS NOT NULL) THEN 
								s.ValidadeP60_StockCodigo

					 WHEN (GETDATE() >= c.P50) AND (s.ValidadeP50_StockCodigo IS NOT NULL) THEN 
								s.ValidadeP50_StockCodigo
		...
		WHERE m.DispensaPrevencaoFalsoStock = CAST('false' as bit)
			  AND (
					((GETDATE() >= c.P90) AND (s.ValidadeP90_StockCodigo IS NOT NULL))
					OR ((GETDATE() >= c.P80) AND (s.ValidadeP80_StockCodigo IS NOT NULL))
					OR ((GETDATE() >= c.P70) AND (s.ValidadeP70_StockCodigo IS NOT NULL))
					OR ((GETDATE() >= c.P60) AND (s.ValidadeP60_StockCodigo IS NOT NULL))
					OR ((GETDATE() >= c.P50) AND (s.ValidadeP50_StockCodigo IS NOT NULL))
				  )
		...
		SET @Info = '[Step4a3_Precautions_FakeStock-01] Number of executed FakeStock preventions: ' + CAST(@@ROWCOUNT as nvarchar);
	...
	BEGIN CATCH
		...
		SET @Info = '[Step4a3_Precautions_FakeStock-02] ' + CAST(ERROR_NUMBER() as nvarchar) + ' - ' + ERROR_MESSAGE();
