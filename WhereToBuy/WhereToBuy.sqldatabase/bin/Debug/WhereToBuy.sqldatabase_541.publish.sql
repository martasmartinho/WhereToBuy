...
GO
PRINT N'Altering [dbo].[ProductMatchingInsert]...';


GO
ALTER PROCEDURE [dbo].[ProductMatchingInsert]
...
AS
	...
	END CATCH
GO
PRINT N'Altering [dbo].[ProductMatchingUpdate]...';


GO
ALTER PROCEDURE [dbo].[ProductMatchingUpdate]
	@FornecedorCodigo nvarchar(5),
	@ComplementoCodigo nvarchar(128),
	@Codigo nvarchar(256),
	@HorasValidadeCotacao smallint,
