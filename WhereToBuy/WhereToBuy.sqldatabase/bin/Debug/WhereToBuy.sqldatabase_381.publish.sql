...
GO
PRINT N'Creating [dbo].[Step4b4_OutOfInterval_Execution]...';
...
CREATE PROCEDURE [dbo].[Step4b4_OutOfInterval_Execution]
...
AS
	...
	BEGIN TRY
		...
		*/
		...
		SET @Info = '[Step4b4_OutOfInterval_Execution-01] Number of deactivated quotations due to Out Of Interval prevent: ' + CAST(@@ROWCOUNT as nvarchar);
	...
	BEGIN CATCH
		...
		SET @Info = '[Step4b4_OutOfInterval_Execution-02] ' + CAST(ERROR_NUMBER() as nvarchar) + ' - ' + ERROR_MESSAGE();
