...
AS
	...
	SET @select = 'SELECT utilizadores.[Username], HASHBYTES(''utilizadores.[Password]'', @Password), utilizadores.[Nome], utilizadores.[Email], utilizadores.[Mobile], utilizadores.[Sms], utilizadores.[Administrador], utilizadores.[Inativo], utilizadores.[Criacao], utilizadores.[Versao]				
