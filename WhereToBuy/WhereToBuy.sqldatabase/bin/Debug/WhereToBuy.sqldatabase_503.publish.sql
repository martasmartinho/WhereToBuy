...
AS
	...
	SET @select = 'SELECT produtos.[Codigo], produtos.[Descricao], produtos.[Partnumber], 
							...
							produtos.[StockCodigo], stocks.[Descricao] as StockDescricao,produtos.[StockCodigo_Data], 
							produtos.[StockCodigo_U1], stocksU1.[Descricao] as StockDescricao_U1, produtos.[StockCodigo_U1Data], 
							produtos.[StockCodigo_U2], stocksU2.[Descricao] as StockDescricao_U2, produtos.[StockCodigo_U2Data], 
							produtos.[StockCodigo_U3], stocksU3.[Descricao] as StockDescricao_U3,produtos.[StockCodigo_U3Data], 
...
AS
	...
	SET @select = 'SELECT * FROM ProductsAtuaisView'
