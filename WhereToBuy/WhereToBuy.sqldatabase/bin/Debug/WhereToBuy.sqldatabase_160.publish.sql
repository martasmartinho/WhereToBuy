...
GO
PRINT N'Altering [dbo].[GetTextoOnlyAllowedCharsFunction]...';
...
ALTER FUNCTION [dbo].GetTextoOnlyAllowedCharsFunction
(
	@texto nvarchar(256),
...
BEGIN
	...
	-- variaveis
	DECLARE @i AS INTEGER = 0, @n AS INTEGER = LEN(@texto), @result nvarchar(256) = '';
	...
	BEGIN
		...
		ELSE
		BEGIN
			-- senão, descarta-o e aumenta ao @n, já que há lugar para mais um caracter...
			SET @n += 1;
		END
