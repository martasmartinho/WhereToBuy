...
BEGIN	
	INSERT INTO [dbo].[AvisosTipo] ([Codigo], [Descricao], [Gravidade], [Notas], [Icon], [Inativo], [Criacao], [Versao])
		VALUES ('PFS', 'Prevenção Falso Stock', 3, NULL, NULL, CAST('false' AS bit), GETDATE(), GETDATE()),
			   ...
			   ('CICM1', 'Cotação Incompleta [Complemento] (mapeamento inativo)', 6, NULL, NULL, CAST('false' AS bit), GETDATE(), GETDATE()),
			   ...
			   ('CIMM1', 'Cotação Incompleta [Marca] (mapeamento inativo)', 6, NULL, NULL, CAST('false' AS bit), GETDATE(), GETDATE()),
			   ...
			   ('CITM1', 'Cotação Incompleta [Categoria] (mapeamento inativo)', 6, NULL, NULL, CAST('false' AS bit), GETDATE(), GETDATE()),
			   ...
			   ('CIIM1', 'Cotação Incompleta [Imposto] (mapeamento inativo)', 6, NULL, NULL, CAST('false' AS bit), GETDATE(), GETDATE()),
			   ...
			   ('CIPM1', 'Cotação Incompleta [Produto] (mapeamento inativo)', 6, NULL, NULL, CAST('false' AS bit), GETDATE(), GETDATE()),
			   ...
			   ('CIPM4', 'Cotação Incompleta [Produto] (produto inativo)', 6, NULL, NULL, CAST('false' AS bit), GETDATE(), GETDATE()),
			   ('CIPM9', 'Cotação Incompleta [Produto] (ambiguidade detetada com outro partnumber de outra marca)', 6, NULL, NULL, CAST('false' AS bit), GETDATE(), GETDATE())
