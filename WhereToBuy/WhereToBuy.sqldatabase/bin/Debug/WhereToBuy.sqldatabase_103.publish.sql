...
RETURN;
GO
PRINT N'Creating [dbo].[Step2a_CleanAllExistingWarnings]...';
...
CREATE PROCEDURE [dbo].[Step2a_CleanAllExistingWarnings]
	@Info nvarchar(256) OUTPUT
AS
	...
	BEGIN CATCH
		...
		SET @Info = '[Step2a_CleanAllExistingWarnings-01] ' + CAST(ERROR_NUMBER() as nvarchar) + ' - ' +ERROR_MESSAGE();
