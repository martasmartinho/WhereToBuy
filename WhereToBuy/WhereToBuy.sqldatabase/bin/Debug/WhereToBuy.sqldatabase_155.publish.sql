...
GO
PRINT N'Creating [dbo].[GetTextoStrippedFunction]...';
...
/*
	...
	Example of use:
	EXEC [dbo].GetTextoStrippedFunction 'Th.-is is the tes!t number 93' '[A-Za-z0-9]'
*/

CREATE FUNCTION [dbo].GetTextoStrippedFunction
(
	@texto nvarchar(256),
