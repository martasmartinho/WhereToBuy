...
GO
PRINT N'Altering [dbo].[Complementos]...';


GO
ALTER TABLE [dbo].[Complementos] ALTER COLUMN [TermoAcrescentar] NVARCHAR (50) NULL;

ALTER TABLE [dbo].[Complementos] ALTER COLUMN [TermosRemover] NVARCHAR (100) NULL;
