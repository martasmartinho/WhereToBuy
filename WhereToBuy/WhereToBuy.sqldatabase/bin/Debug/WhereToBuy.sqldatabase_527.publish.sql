...
GO
PRINT N'Creating [dbo].[FK_Utilizador_Idioma]...';


GO
ALTER TABLE [dbo].[Utilizadores]
    ADD CONSTRAINT [FK_Utilizador_Idioma] FOREIGN KEY ([IdiomaCodigo]) REFERENCES [dbo].[Idiomas] ([Codigo]);
...
GO
PRINT N'Creating [dbo].[ProdutosView]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[CatalogCount]...';
...
RETURN  -- This SP must be used with ExecuteScalar
GO
PRINT N'Creating [dbo].[CatalogDelete]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[CatalogInsert]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[CatalogSelect]...';
...
RETURN @@ROWCOUNT
GO
PRINT N'Creating [dbo].[CatalogUpdate]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[CategoryMatchingCount]...';
...
RETURN  -- This SP must be used with ExecuteScalar
GO
PRINT N'Creating [dbo].[CategoryMatchingDelete]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[CategoryMatchingInsert]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[CategoryMatchingSelect]...';
...
RETURN @@ROWCOUNT
GO
PRINT N'Creating [dbo].[CategoryMatchingUpdate]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[ClassInsert]...';
...
RETURN;
GO
PRINT N'Creating [dbo].[GroupCount]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[GroupInsert]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[GroupSelect]...';
...
RETURN  -- This SP must be used with ExecuteScalar
GO
PRINT N'Creating [dbo].[ProductDelete]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[ProductInsert]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[ProductMatchingCount]...';
...
RETURN  -- This SP must be used with ExecuteScalar
GO
PRINT N'Creating [dbo].[ProductMatchingDelete]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[ProductMatchingInsert]...';
...
AS
	...
	BEGIN TRY
		...
		-- INSERIR REGISTO
		INSERT INTO [dbo].[ProdutosMatching] ([FornecedorCodigo], [Codigo], [Descricao], [MapTo], 
					...
					VALUES (@FornecedorCodigo, @Codigo, @Descricao, @MapTo, @HorasValidadeCotacao, @StockCodigoSubstituto,
	...
	END CATCH
GO
PRINT N'Creating [dbo].[ProductMatchingSelect]...';
...
AS
	...
	SET @select = 'SELECT matching.[FornecedorCodigo], fornecedores.[Nome] as FornecedorNome, matching.[Codigo], matching.[ComplementoCodigo],
							matching.[Descricao], matching.[HorasValidadeCotacao], matching.[StockCodigoSubstituto], stocks.[Descricao] as StockDescricao,
							matching.[DispensaPrevencaoPrecosDesfasados],  matching.[DispensaPrevencaoPrecosDesfasados],
							matching.[DataReset], matching.[MapTo], produtos.[Descricao] as ProdutoDescricao, matching.[Inativo], matching.[Criacao], matching.[Versao]				
						FROM [dbo].[ProdutosMatching] matching 
						INNER JOIN [dbo].[Fornecedores] fornecedores
							ON matching.[FornecedorCodigo] = fornecedores.[Codigo] AND fornecedores.[INATIVO]='+'''FALSE''
						INNER JOIN [dbo].[Stocks] stocks
							ON matching.[StockCodigoSubstituto] = stocks.[Codigo] AND stocks.[INATIVO]='+'''FALSE''
						INNER JOIN [dbo].[Produtos] produtos
							ON matching.[MapTo] = produtos.[Codigo] AND produtos.[INATIVO]='+'''FALSE'''
...
RETURN @@ROWCOUNT
GO
PRINT N'Creating [dbo].[ProductMatchingUpdate]...';
...
AS
	...
	BEGIN TRY
		...
		-- ALTERAR REGISTO
		UPDATE [dbo].[ProdutosMatching] SET [Descricao] = @Descricao,
									[MapTo] = @MapTo,
	...
	END CATCH
GO
PRINT N'Creating [dbo].[ProductSelect]...';
...
AS
	...
	SET @select = 'SELECT p.[Codigo], p.[Descricao], p.[Partnumber], 
							...
							p.[FornecedorCodigo], f.[Nome] as FonecedorNome, COALESCE(f.[ProdutosConfiancaPreco],0) as ProdutosConfiancaPreco, COALESCE(f.[ProdutosConfiancaDisponibilidade],0) as ProdutosConfiancaDisponibilidade,
...
RETURN @@ROWCOUNT
GO
PRINT N'Creating [dbo].[ProductUpdate]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[StateMatchingCount]...';
...
RETURN  -- This SP must be used with ExecuteScalar
GO
PRINT N'Creating [dbo].[StateMatchingDelete]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[StateMatchingInsert]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[StateMatchingSelect]...';
...
RETURN @@ROWCOUNT
GO
PRINT N'Creating [dbo].[StateMatchingUpdate]...';
...
RETURN;
GO
PRINT N'Creating [dbo].[StockCount]...';
...
RETURN  -- This SP must be used with ExecuteScalar
GO
PRINT N'Creating [dbo].[StockDelete]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[StockInsert]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[StockMatchingCount]...';
...
RETURN  -- This SP must be used with ExecuteScalar
GO
PRINT N'Creating [dbo].[StockMatchingDelete]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[StockMatchingInsert]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[StockMatchingSelect]...';
...
RETURN @@ROWCOUNT
GO
PRINT N'Creating [dbo].[StockMatchingUpdate]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[StockSelect]...';
...
RETURN @@ROWCOUNT
GO
PRINT N'Creating [dbo].[StockUpdate]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[SupplementMatchingCount]...';
...
RETURN  -- This SP must be used with ExecuteScalar
GO
PRINT N'Creating [dbo].[SupplementMatchingDelete]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[SupplementMatchingInsert]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[SupplementMatchingSelect]...';
...
RETURN @@ROWCOUNT
GO
PRINT N'Creating [dbo].[SupplementMatchingUpdate]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[SupplierBrandCount]...';
...
RETURN  -- This SP must be used with ExecuteScalar
GO
PRINT N'Creating [dbo].[SupplierBrandDelete]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[SupplierBrandInsert]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[SupplierBrandSelect]...';
...
RETURN @@ROWCOUNT
GO
PRINT N'Creating [dbo].[SupplierBrandUpdate]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[TaxMatchingCount]...';
...
RETURN  -- This SP must be used with ExecuteScalar
GO
PRINT N'Creating [dbo].[TaxMatchingDelete]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[TaxMatchingInsert]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[TaxMatchingSelect]...';
...
RETURN @@ROWCOUNT
GO
PRINT N'Creating [dbo].[TaxMatchingUpdate]...';
...
AS
	...
	END CATCH
GO
PRINT N'Creating [dbo].[ViewProductSelect]...';
