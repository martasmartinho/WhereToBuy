...
BEGIN
			...
			@eepFormula = 
				CASE WHEN @U3Data IS NOT NULL THEN 
													'EEP = 0.1(U3Data - U2Data) + ' +
														  '0.4(U2Data - U1Data) + ' +
													      '0.5(U1Data - UData) <=> ' +
													'EEP = 0.1(' + CONVERT(varchar, @U3Data, 113) + ' - ' + CONVERT(varchar, @U2Data, 113)  + ') + ' +
													      '0.4(' + CONVERT(varchar, @U2Data, 113) + ' - ' + CONVERT(varchar, @U1Data, 113)  + ') + ' +
														  '0.5(' + CONVERT(varchar, @U1Data, 113) + ' - ' + CONVERT(varchar, @UData, 113)  + ') <=> ' +
	...
	INSERT INTO @results
	SELECT @u3vp, @u2vp, @u1vp, @eep, 1, @eepFormula, null, null, null, null;
	/*
	EEP float NOT NULL,
	ICP float NOT NULL,
	EEPFormula nvarchar(256),
