...
GO
PRINT N'Dropping [dbo].[FK_Classes_Catalogo]...';


GO
ALTER TABLE [dbo].[Classes] DROP CONSTRAINT [FK_Classes_Catalogo];


GO
PRINT N'Starting rebuilding table [dbo].[Catalogos]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_Catalogos] (
    ...
    CONSTRAINT [tmp_ms_xx_constraint_PK_Catalogos] PRIMARY KEY CLUSTERED ([Codigo] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Catalogos])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Catalogos] ([Codigo], [Descricao], [Inativo], [Criacao], [Versao])
        SELECT   [Codigo],
                 [Descricao],
                 [Inativo],
                 [Criacao],
...
EXECUTE sp_rename N'[dbo].[tmp_ms_xx_Catalogos]', N'Catalogos';

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_constraint_PK_Catalogos]', N'PK_Catalogos', N'OBJECT';
...
GO
PRINT N'Starting rebuilding table [dbo].[Classes]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_Classes] (
    [Codigo]            NVARCHAR (20)   NOT NULL,
    [Descricao]         NVARCHAR (50)   NOT NULL,
    ...
    [Criacao]           SMALLDATETIME   NOT NULL,
    [Versao]            DATETIME        NOT NULL,
    CONSTRAINT [tmp_ms_xx_constraint_PK_Classes] PRIMARY KEY CLUSTERED ([Codigo] ASC)
);

IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[Classes])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_Classes] ([Codigo], [Descricao], [CatalogoCodigo], [Margem], [MargemValorMinimo], [Inativo], [Criacao], [Versao])
        SELECT   [Codigo],
                 [Descricao],
                 [CatalogoCodigo],
                 [Margem],
...
EXECUTE sp_rename N'[dbo].[tmp_ms_xx_Classes]', N'Classes';

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_constraint_PK_Classes]', N'PK_Classes', N'OBJECT';
