...
GO
PRINT N'Altering [dbo].[CategorySelect]...';


GO
ALTER PROCEDURE [dbo].[CategorySelect]
...
AS
	...
	SET @select = 'SELECT c.[Codigo], c.[Descricao], c.[PesoMedioUnidade], c.[PrecoMinimoPermitido], c.[PrecoMaximoPermitido], c.[PrecoAmplitudeMax], c.[Confianca], c.[Inativo], c.[Criacao], marcas.[Versao]				
