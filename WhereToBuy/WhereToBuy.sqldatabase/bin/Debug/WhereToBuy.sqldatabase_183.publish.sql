...
AS
	...
	BEGIN TRY
		...
		*/
		INSERT [dbo].[Produtos] 
			   (
					Codigo, MarcaCodigo, CategoriaCodigo, ImpostoCodigo, Partnumber, Descricao,
					Descontinuado, Inativo, Versao
			   )

		SELECT Referencia, MarcaCodigo, CategoriaCodigo, ImpostoCodigo, Partnumber, '(' + Partnumber + ')',
		       CAST('false' as bit), CAST('false' as bit), GETDATE()
