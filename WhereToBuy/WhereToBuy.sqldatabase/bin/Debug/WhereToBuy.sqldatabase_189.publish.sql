...
GO
PRINT N'Creating [dbo].[Step2c5_MappingProducts_Notifications]...';
...
CREATE PROCEDURE [dbo].[Step2c5_MappingProducts_Notifications]
...
AS
	...
	BEGIN TRY
		...
		*/
		...
		SET @Info = '[Step2c5_MappingProducts_Notifications-01] Number of inserted notifications: ' + CAST(@@ROWCOUNT as nvarchar);
	...
	BEGIN CATCH
		...
		SET @Info = '[Step2c5_MappingProducts_Notifications-02] ' + CAST(ERROR_NUMBER() as nvarchar) + ' - ' + ERROR_MESSAGE();
