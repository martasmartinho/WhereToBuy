...
GO
PRINT N'Altering [dbo].[BrandUpdate]...';


GO
ALTER PROCEDURE [dbo].[BrandUpdate]
	@Codigo nvarchar(5),
...
AS
	...
	END CATCH
GO
PRINT N'Altering [dbo].[CategoryUpdate]...';
...
AS
	...
	END CATCH
GO
PRINT N'Altering [dbo].[LanguageUpdate]...';


GO
ALTER PROCEDURE [dbo].[LanguageUpdate]
	@Codigo nvarchar(5),
	@Descricao nvarchar(50),
	@Inativo bit,
	@Versao datetime
AS
	...
	END CATCH
GO
PRINT N'Altering [dbo].[StateUpdate]...';


GO
ALTER PROCEDURE [dbo].[StateUpdate]
	@Codigo nvarchar(5),
	@Descricao nvarchar(50),
	@Inativo bit,
	@Versao datetime
AS
	...
	END CATCH
GO
PRINT N'Altering [dbo].[SupplementUpdate]...';


GO
ALTER PROCEDURE [dbo].[SupplementUpdate]
	@Codigo nvarchar(5),
	@Descricao nvarchar(50),
...
AS
	...
	END CATCH
GO
PRINT N'Altering [dbo].[TaxUpdate]...';
...
AS
	...
	END CATCH
GO
PRINT N'Altering [dbo].[WarningTypeUpdate]...';


GO
ALTER PROCEDURE [dbo].[WarningTypeUpdate]
	@Codigo nvarchar(5),
...
AS
	...
	END CATCH
GO
PRINT N'Altering [dbo].[WorryingTermCount]...';


GO
ALTER PROCEDURE [dbo].[WorryingTermCount]
...
AS
	...
	SET @select = 'SELECT Count([Codigo]) FROM [dbo].[TermosPreocupantes]' 
...
GO
PRINT N'Altering [dbo].[WorryingTermDelete]...';


GO
ALTER PROCEDURE [dbo].[WorryingTermDelete]
	@Termo nvarchar(5),
	@Versao datetime
AS
	DECLARE @Erro nvarchar(255)
...
AS
	...
	END CATCH
GO
PRINT N'Altering [dbo].[WorryingTermSelect]...';


GO
ALTER PROCEDURE [dbo].[WorryingTermSelect]
...
RETURN @@ROWCOUNT
GO
PRINT N'Altering [dbo].[WorryingTermUpdate]...';


GO
ALTER PROCEDURE [dbo].[WorryingTermUpdate]
	@Termo nvarchar(50),
	@Indice tinyint,
	@Notas nvarchar(256),
	@Inativo bit,
