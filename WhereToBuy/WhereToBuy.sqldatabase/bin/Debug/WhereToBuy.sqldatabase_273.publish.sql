	...
	BEGIN TRANSACTION
		...
		BEGIN TRY
			...
			*/
			...
			SET @Info += '[Step3b1_Promotion_PromoteQuotations-01] Number of disabled Actual Quotations: ';
			SET @Info = CAST(@@ROWCOUNT as nvarchar);
			...
			*/
			...
			-- fill output @info with sucess message
			SET @Info += '; Number of promoted Quotations: ';
			SET @Info += CAST(@@ROWCOUNT as nvarchar);
