...
AS
	...
	IF LEN(TRIM(@FornecedorCodigo)) < 1
	BEGIN
		-- disparar um erro
	...
	IF LEN(TRIM(@_ComplementoCodigo)) < 1
	BEGIN
		-- disparar um erro
	...
	IF LEN(TRIM(@_ComplementoDescricao)) < 1
	BEGIN
		-- disparar um erro
	...
	IF LEN(TRIM(@_CategoriaCodigo)) < 1
	BEGIN
		-- disparar um erro
	...
	IF LEN(TRIM(@_CategoriaDescricao)) < 1
	BEGIN
		-- disparar um erro
	...
	IF LEN(TRIM(@_ImpostoDescricao)) < 1
	BEGIN
		-- disparar um erro
	...
	IF LEN(TRIM(@_Caracteristicas)) < 1
	BEGIN
		-- disparar um erro
	...
	IF LEN(TRIM(@_OutrosCustosDescricao)) < 1
	BEGIN
		-- disparar um erro
