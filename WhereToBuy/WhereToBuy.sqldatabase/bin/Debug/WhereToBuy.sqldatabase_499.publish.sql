...
GO
PRINT N'Altering [dbo].[QuotationRuleSelect]...';


GO
ALTER PROCEDURE [dbo].[QuotationRuleSelect]
...
AS
	...
	SET @select = 'SELECT produtos.[Codigo], produtos.[Descricao], produtos.[Partnumber], 
							...
							produtos.[StockCodigo], produtos.[StockCodigo_Data], 
							produtos.[StockCodigo_U1], produtos.[StockCodigo_U1Data], 
							produtos.[StockCodigo_U2], produtos.[StockCodigo_U2Data], 
							produtos.[StockCodigo_U3], produtos.[StockCodigo_U3Data], 
						...
						LEFT JOIN  [dbo].[Categorias] categorias
							ON categorias.[Codigo] = [CategoriaCodigo]
						LEFT JOIN  [dbo].[Marcas] marcas
							ON marcas.[Codigo] = [MarcaCodigo]
						LEFT JOIN  [dbo].[Impostos] impostos
							ON impostos.[Codigo] = [ImpostoCodigo]
						LEFT JOIN  [dbo].[Fornecedores] fornecedores
							ON fornecedores.[Codigo] = [FornecedorCodigo]' 
