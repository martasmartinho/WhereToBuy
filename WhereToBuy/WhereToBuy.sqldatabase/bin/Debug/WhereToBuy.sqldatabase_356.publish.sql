...
CREATE TABLE [dbo].[tmp_ms_xx_ProdutosMatching] (
    ...
    [DispensaPrevencaoPrecosDesfazados] BIT            NOT NULL,
    [DispensaPrevencaoFalsoStock]       BIT            NULL,
...
RETURN;
GO
PRINT N'Refreshing [dbo].[Step2c1_MappingProducts_FeedNewRules]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[Step2c1_MappingProducts_FeedNewRules]';
