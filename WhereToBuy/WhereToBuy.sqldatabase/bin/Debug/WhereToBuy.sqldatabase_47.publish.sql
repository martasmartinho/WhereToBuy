...
GO
PRINT N'Dropping [dbo].[CotacoesAtivas].[IDX_CotacoesAtivas]...';


GO
DROP INDEX [IDX_CotacoesAtivas]
    ON [dbo].[CotacoesAtivas];


GO
PRINT N'Altering [dbo].[CotacoesAtivas]...';
...
ALTER VIEW [dbo].[CotacoesAtivas] WITH SchemaBinding -- todos os campos têm que ser especificados pelo facto de ser uma view materializada
	AS 
	SELECT [FornecedorCodigo], [Data], [_ProdutoCodigo], [_ComplementoCodigo], [_ComplementoDescricao],
		   ...
		   [Completo], [Integrado],
		   -- [Inativo], -- campos não faz sentido pertencer às CotacoesAtivas porque é redondante
		   [Versao]
...
GO
PRINT N'Creating [dbo].[CotacoesAtivas].[IDX_CotacoesAtivas]...';


GO
CREATE UNIQUE CLUSTERED INDEX [IDX_CotacoesAtivas]
    ON [dbo].[CotacoesAtivas]([FornecedorCodigo] ASC, [Data] ASC, [_ProdutoCodigo] ASC, [_ComplementoCodigo] ASC);


GO
PRINT N'Creating [dbo].[CotacoesNaoIntegradas]...';
...
CREATE VIEW [dbo].[CotacoesNaoIntegradas]
	AS 
	SELECT *
	FROM [dbo].[CotacoesAtivas]
