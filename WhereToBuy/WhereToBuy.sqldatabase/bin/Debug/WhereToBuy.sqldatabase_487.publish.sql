...
GO
PRINT N'Altering [dbo].[BrandMatchingDelete]...';


GO
ALTER PROCEDURE [dbo].[BrandMatchingDelete]
...
AS
	...
	END CATCH
GO
PRINT N'Altering [dbo].[BrandMatchingInsert]...';


GO
ALTER PROCEDURE [dbo].[BrandMatchingInsert]
	@FornecedorCodigo nvarchar(5),
	@Codigo nvarchar(128),
...
AS
	...
	END CATCH
GO
PRINT N'Altering [dbo].[BrandMatchingUpdate]...';


GO
ALTER PROCEDURE [dbo].[BrandMatchingUpdate]
	@FornecedorCodigo nvarchar(5),
	@Codigo nvarchar(128),
	@Descricao nvarchar(128),
	@MapTo nvarchar(5),
...
AS
	...
	END CATCH
GO
PRINT N'Altering [dbo].[CategoryMatchingDelete]...';


GO
ALTER PROCEDURE [dbo].[CategoryMatchingDelete]
	@FornecedorCodigo nvarchar(5),
	@Codigo nvarchar(128),
	@Versao datetime
AS
