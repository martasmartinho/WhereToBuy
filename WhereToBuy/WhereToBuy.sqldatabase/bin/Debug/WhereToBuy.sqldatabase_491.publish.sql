...
AS
	...
	SET @select = 'SELECT fm.[FornecedorCodigo], fornecedores.[Nome] as FornecedorNome, marcas.[Codigo] as Marca Codigo, marcas.[Descricao] as Marca Descricao, fm.[Confianca], 
							fm.[Notas], fm.[Versao]				
