...
BEGIN
	...
	SELECT 
			...
			@justificacao =
				CASE WHEN @ProdutosMatching_StockCodigo IS NOT NULL THEN 'Imposição por regra do produto (ProdutosMatching)'
					 WHEN @CotacoesRegras_StockCodigo IS NOT NULL THEN 'Imposição por regra de cotação (CotacoesRegras)'
					 ELSE NULL
				END
