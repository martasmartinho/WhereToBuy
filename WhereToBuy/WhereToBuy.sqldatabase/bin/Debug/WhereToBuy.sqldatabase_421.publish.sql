...
GO
PRINT N'Altering [dbo].[Step4a1_Preparation_Notifications]...';
...
ALTER PROCEDURE [dbo].[Step4a1_Preparation_Notifications]
	...
	BEGIN TRY
		...
		*/
		...
		SELECT NEWID() AS Id, 
			   ...
			   'esta informação pode resultar de uma alteração recente da formula de normalização ou de uma alteração do sistema externo!' AS Descricao,
			   GETDATE() AS Criacao
