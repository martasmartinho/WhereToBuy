...
ALTER VIEW [dbo].[ProdutosAtuaisView]
	...
	SELECT p.*, 
		   ...
		   COALESCE(f.ProdutosConfiancaPreco, 0) as ProdutoConfiancaPreco,
		   COALESCE
			   (
					(
...
GO
PRINT N'Altering [dbo].[ProductDetailsDelete]...';


GO
ALTER PROCEDURE [dbo].[ProductDetailsDelete]
...
AS
	...
	END CATCH
GO
PRINT N'Altering [dbo].[ProductDetailsSelect]...';


GO
ALTER PROCEDURE [dbo].[ProductDetailsSelect]
...
AS
	...
	SET @select = 'SELECT [dbo].[ProdutoCodigo]
					   ,[FornecedorCodigo]
