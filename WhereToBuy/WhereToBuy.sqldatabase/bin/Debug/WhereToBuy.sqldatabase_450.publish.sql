...
AS
	...
	SET @select = 'SELECT utilizadores.[Username], utilizadores.[Password], utilizadores.[Nome], utilizadores.[Email], utilizadores.[Mobile], utilizadores.[Sms], utilizadores.[Inativo], utilizadores.[Criacao], utilizadores.[Versao]				
