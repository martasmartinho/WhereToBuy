...
GO
PRINT N'Altering [dbo].[Step1a1_DeleteNotIntegratedExistingQuotations]...';
...
ALTER PROCEDURE [dbo].[Step1a1_DeleteNotIntegratedExistingQuotations]
...
AS
	...
	BEGIN TRY
		...
		SET @Info = '[Step1a1_DeleteNotIntegratedExistingQuotations-01] Were removed sucessfully, ' + CAST(@numberOfAffectedRows as nvarchar) + ' not integrated and incomplete quotations of the supplier ' + @FornecedorCodigo +'.';
