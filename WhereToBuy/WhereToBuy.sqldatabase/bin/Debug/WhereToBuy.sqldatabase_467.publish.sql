...
GO
PRINT N'Altering [dbo].[TaxCount]...';


GO
ALTER PROCEDURE [dbo].[TaxCount]
...
GO
PRINT N'Altering [dbo].[TaxDelete]...';


GO
ALTER PROCEDURE [dbo].[TaxDelete]
	@Codigo nvarchar(5),
	@Versao datetime
AS
...
AS
	...
	END CATCH
GO
PRINT N'Altering [dbo].[TaxSelect]...';


GO
ALTER PROCEDURE [dbo].[TaxSelect]
...
AS
	...
	BEGIN TRY
		...
		UPDATE [dbo].[Impostos] SET [Descricao] = @Descricao,
									[DesignacaoFiscal] = @DesiganacaoFiscal,
									[Taxa] = @Taxa,
									[Versao] = @NovaVersao
								WHERE [Codigo] = @Codigo
