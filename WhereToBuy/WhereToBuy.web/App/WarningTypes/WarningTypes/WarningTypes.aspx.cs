...
namespace WhereToBuy.web.App.WarningTypes.WarningTypes
{
    public partial class WarningTypes : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ((MessageUC)(WarningTypesUC.FindControl("MessageUC"))).SubmitButtonClick += WarningTypes_MessageButton;
        ...
        private void WarningTypes_MessageButton(object sender, EventArgs e)
        {
