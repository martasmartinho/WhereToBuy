...
namespace WhereToBuy.web.App.Brands.Brands
{
    public partial class Brands : System.Web.UI.Page
    {
        ...
        {
            //create event
            ((MessageUC)(BrandsUC.FindControl("MessageUC"))).SubmitButtonClick += Brands_MessageButton;
            ...
            if (!Page.IsPostBack)
            {
                ...
                // load data
                BrandsUC.UpdateData(code, dataState);
            }
        }


        private void Brands_MessageButton(object sender, EventArgs e)
        {
