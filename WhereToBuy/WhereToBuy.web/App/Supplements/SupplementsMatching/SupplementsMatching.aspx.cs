...
namespace WhereToBuy.web.App.Supplements.SupplementsMatching
{
    public partial class SupplementsMatching : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ((MessageUC)(SupplementsMatchingUC.FindControl("MessageUC"))).SubmitButtonClick += SupplementsMatching_MessageButton;
            ((SuppliersSelBox)(SupplementsMatchingUC.FindControl("SuppliersSelBox"))).SubmitButtonClick += SupplementsMatching_ClickButton;
            ...
            if (!Page.IsPostBack)
            {
                ...
                // load data
                SupplementsMatchingUC.UpdateData(supplierCode, code, dataState);
        ...
        private void SupplementsMatching_ClickButton(object sender, SupplierSelBoxEventArgs e)
        {
            ScriptManager.RegisterStartupScript(this, this.GetType(), "sp", "invokeDummyButton('" + "Suppliers" + "');", true);
        }

        private void SupplementsMatching_MessageButton(object sender, EventArgs e)
        {
