...
namespace WhereToBuy.web.App.Classes.Classes
{
    public partial class Classes : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ((MessageUC)(ClassesUC.FindControl("MessageUC"))).SubmitButtonClick += Classes_MessageButton;
        ...
        private void Classes_MessageButton(object sender, EventArgs e)
        {
