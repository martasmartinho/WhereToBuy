...
namespace WhereToBuy.web.App.Categories.Categories
{
    public partial class Categories : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ((MessageUC)(CategoriesUC.FindControl("MessageUC"))).SubmitButtonClick += Categories_MessageButton;
        ...
        private void Categories_MessageButton(object sender, EventArgs e)
        {
