<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CategoriesMatchingUC.ascx.cs" Inherits="WhereToBuy.web.UserControls.Categories.CategoriesMatching.CategoriesMatchingUC" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <h2>
                                <asp:Label ID="lblTitle" CssClass="text-primary top-left" runat="server" Text="<%$ Resources:lang, CategoriesMatchingString %>"></asp:Label>
                            </h2>
                        </div>
                        <div class="col-lg-6">
                            <div class="row">
                    ...
                    <div class="navbar row">
                        <asp:GridView ID="gvCategoriesMatching" CssClass="table table-responsive" runat="server" AllowSorting="true"
                            AllowPaging="True" PageSize="10" OnPageIndexChanged="gvCategoriesMatching_PageIndexChanged" OnPageIndexChanging="gvCategoriesMatching_PageIndexChanging"
                            OnRowDataBound="gvCategoriesMatching_RowDataBound"
                            OnRowCommand="gvCategoriesMatching_RowCommand" OnRowCreated="gvCategoriesMatching_RowCreated" OnSorting="gvCategoriesMatching_Sorting">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="<%$ Resources:lang, SupplierString %>" SortExpression="Supplier.Name">
                                    ...
                                    <ItemTemplate>
                                        <div>
                                            <asp:Label ID="SupplierLabel" runat="server" Text='<%# string.Format("{0}<p/>{1}",((WhereToBuy.entities.CategoryMatching)Container.DataItem).Supplier.Code, 
                                                                                                                                                        ((WhereToBuy.entities.CategoryMatching)Container.DataItem).Supplier.Name )%>'>
                                            </asp:Label>
                                        </div>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Code/Description" SortExpression="FirstName">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblCode" runat="server" Text='<%# string.Format("{0}<p/>{1}",((WhereToBuy.entities.CategoryMatching)Container.DataItem).Code, 
                                                                                                                                                        ((WhereToBuy.entities.CategoryMatching)Container.DataItem).Description)%>'>
                                        </asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle Width="25%" HorizontalAlign="Left" VerticalAlign="Top" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Category" SortExpression="CategoryDescription">
                                    <HeaderTemplate>
                                        <asp:LinkButton runat="server" ID="lnkCategory" CommandName="Sort" CommandArgument="MapTo" CssClass="btn-link" Font-Bold="true" Text="<%$ Resources:lang, CategoryString %>">Brand</asp:LinkButton>
                                    </HeaderTemplate>

                                    <ItemTemplate>
                                        <asp:Label ID="lblMapToCode" runat="server"
                                            Text='<%# ((WhereToBuy.entities.CategoryMatching)Container.DataItem).MapTo !=null ? string.Format("[{0}] {1}", ((WhereToBuy.entities.CategoryMatching)Container.DataItem).MapTo.Code,
                                                      ((WhereToBuy.entities.CategoryMatching)Container.DataItem).MapTo.Description) : string.Empty %>'></asp:Label>
                                    </ItemTemplate>
