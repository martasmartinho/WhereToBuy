<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CategoriesUC.ascx.cs" Inherits="WhereToBuy.web.UserControls.Categories.Categories.CategoriesUC" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <h2>
                                <asp:Label ID="lblTitle" CssClass="text-primary top-left" runat="server" Text="<%$ Resources:lang, CategoriesString %>"></asp:Label>
                            </h2>
                        </div>
                        <div class="col-lg-6">
                            <div class="row">
                    ...
                    <div class="navbar row">
                        <asp:GridView ID="gvCategories" CssClass="table table-responsive" runat="server" AllowSorting="true"
                            AllowPaging="True" PageSize="10" OnPageIndexChanged="gvCategories_PageIndexChanged" OnPageIndexChanging="gvCategories_PageIndexChanging" 
                            OnRowDataBound="gvCategories_RowDataBound" OnSelectedIndexChanging="gvCategories_SelectedIndexChanging" OnSelectedIndexChanged="gvCategories_SelectedIndexChanged"
                            OnRowCommand="gvCategories_RowCommand" OnRowCreated="gvCategories_RowCreated" OnSorting="gvCategories_Sorting">

                            <Columns>

                                <asp:BoundField DataField="Category.Code" HeaderText="<%$ Resources:lang, CodeString %>" ReadOnly="True"
                                    SortExpression="Supplier.Code" Visible="false" />
                                <asp:TemplateField HeaderText="<%$ Resources:lang, CodeString %>" SortExpression="Category.Code">
                                    <HeaderTemplate>
                                ...
                                <asp:TemplateField HeaderText="<%$ Resources:lang, DescriptionString %>" SortExpression="FirstName">
                                    ...
                                    <ItemTemplate>
                                      ...
                                      <asp:Panel ID="pnlExtraInformation" runat="server" style="border-top:1px solid; border-top-color:#428BCA" >
                                         <p></p>
                                          <asp:Label ID="lblExtraInformation" runat="server" Text='<%# string.Format("<p/>{0}: {1}<p/>{2}: {3}<p/>{4}: {5}<p/>{6}: {7}<p/>{8}: {9}<p/>{10}: {11}", this.GetGlobalResourceObject("lang", "UnityWeightAverageString") as string,((WhereToBuy.entities.Category)Container.DataItem).UnityWeightAverage, 
                                                                                                                                                         this.GetGlobalResourceObject("lang", "MinPriceAllowedString") as string, ((WhereToBuy.entities.Category)Container.DataItem).MinPriceAllowed ,
                                                                                                                                                         this.GetGlobalResourceObject("lang", "MaxPriceAllowedString") as string, ((WhereToBuy.entities.Category)Container.DataItem).MaxPriceAllowed ,
                                                                                                                                                         this.GetGlobalResourceObject("lang", "MaxPriceAmplitudeString") as string, ((WhereToBuy.entities.Category)Container.DataItem).MaxPriceAmplitude ,
                                                                                                                                                         this.GetGlobalResourceObject("lang", "CreationString") as string, ((WhereToBuy.entities.Category)Container.DataItem).Creation,
                                                                                                                                                         this.GetGlobalResourceObject("lang", "VersionString") as string, ((WhereToBuy.entities.Category)Container.DataItem).Version)%>'>
                                        </asp:Label>
