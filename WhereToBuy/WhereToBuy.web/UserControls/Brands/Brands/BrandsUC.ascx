<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BrandsUC.ascx.cs" Inherits="WhereToBuy.web.UserControls.Brands.Brands.BrandsUC" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <h2>
                                <asp:Label ID="lblTitle" CssClass="text-primary top-left" runat="server" Text="<%$ Resources:lang, BrandsString %>"></asp:Label>
                            </h2>
                        </div>
                        <div class="col-lg-6">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="navbar-btn navbar-right">
                                        <h2>
                                            ...
                                            <asp:Button ID="bynUpdateElement" CssClass="btn btn-link btn-lg right" runat="server" Text="<%$ Resources:lang, EditString %>" OnClick="btnUpdateElement_Click" /></h2>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="navbar row">
                        <asp:GridView ID="gvBrands" CssClass="table table-responsive" runat="server" AllowSorting="true"
                            AllowPaging="True" PageSize="10" OnPageIndexChanged="gvBrands_PageIndexChanged" OnPageIndexChanging="gvBrands_PageIndexChanging"
                            OnRowDataBound="gvBrands_RowDataBound"
                            OnRowCommand="gvBrands_RowCommand" OnRowCreated="gvBrands_RowCreated" OnSorting="gvBrands_Sorting">
                            <Columns>
                                <asp:BoundField DataField="Brand.Code" HeaderText="<%$ Resources:lang, CodeString %>" ReadOnly="True"
