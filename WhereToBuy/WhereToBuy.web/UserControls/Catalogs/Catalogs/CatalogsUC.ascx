<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CatalogsUC.ascx.cs" Inherits="WhereToBuy.web.UserControls.Catalogs.Catalogs.CatalogsUC" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <h2>
                                <asp:Label ID="lblTitle" CssClass="text-primary top-left" runat="server" Text="<%$ Resources:lang, CatalogsString %>"></asp:Label>
                            </h2>
                        </div>
                        <div class="col-lg-6">
                            <div class="row">
                    ...
                    <div class="navbar row">
                        <asp:GridView ID="gvCatalogs" CssClass="table table-responsive" runat="server" AllowSorting="true"
                            AllowPaging="True" PageSize="10" OnPageIndexChanged="gvCatalogs_PageIndexChanged" OnPageIndexChanging="gvCatalogs_PageIndexChanging" 
                            OnRowDataBound="gvCatalogs_RowDataBound" OnSelectedIndexChanging="gvCatalogs_SelectedIndexChanging" OnSelectedIndexChanged="gvCatalogs_SelectedIndexChanged"
                            OnRowCommand="gvCatalogs_RowCommand" OnRowCreated="gvCatalogs_RowCreated" OnSorting="gvCatalogs_Sorting">

                            <Columns>

                                <asp:BoundField DataField="Catalog.Code" HeaderText="<%$ Resources:lang, CodeString %>" ReadOnly="True"
                                    SortExpression="Supplier.Code" Visible="false" />
                                <asp:TemplateField HeaderText="<%$ Resources:lang, CodeString %>" SortExpression="Catalog.Code">
                                    <HeaderTemplate>
                                ...
                                <asp:TemplateField HeaderText="<%$ Resources:lang, DescriptionString %>" SortExpression="FirstName">
                                    ...
                                    <ItemTemplate>
                                      ...
                                      <asp:Panel ID="pnlExtraInformation" runat="server" style="border-top:1px solid; border-top-color:#428BCA" >
                                         <p></p>
                                          <asp:Label ID="lblExtraInformation" runat="server" Text='<%# string.Format("<p/>{0}: {1}<p/>{2}: {3}<p/>{4}: {5}", this.GetGlobalResourceObject("lang", "NotesString") as string,((WhereToBuy.entities.Catalog)Container.DataItem).Notes, 
                                                                                                                                                         this.GetGlobalResourceObject("lang", "CreationString") as string, ((WhereToBuy.entities.Catalog)Container.DataItem).Creation,
                                                                                                                                                         this.GetGlobalResourceObject("lang", "VersionString") as string, ((WhereToBuy.entities.Catalog)Container.DataItem).Version)%>'>
                                        </asp:Label>
