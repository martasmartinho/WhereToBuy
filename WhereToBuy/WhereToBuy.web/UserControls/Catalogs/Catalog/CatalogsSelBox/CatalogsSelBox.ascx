    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="CatalogSelBoxPanel" runat="server" CssClass="row">
            <div class="col-xs-10 col-sm-10 col-lg-11">
                <div class="dropdown">
                    <asp:TextBox ID="txtCatalog" CssClass="form-control" runat="server" AutoPostBack="true" AutoCompleteType="Disabled"></asp:TextBox>
            ...
            <div class="col-xs-2 col-sm-2 col-lg-1">
                <asp:LinkButton ID="lkBtnSearch" runat="server" CssClass="btn btn-primary dropdown-toggle" OnClick="lkBtnSearch_Click" onFocus="this.click()"><span class="glyphicon glyphicon-search" ></span></asp:LinkButton>
            </div>
        </asp:Panel>
