<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WarningTypesUC.ascx.cs" Inherits="WhereToBuy.web.UserControls.WarningTypes.WarningTypes.WarningTypesUC" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <h2>
                                <asp:Label ID="lblTitle" CssClass="text-primary top-left" runat="server" Text="<%$ Resources:lang, WarningTypesString %>"></asp:Label>
                            </h2>
                        </div>
                        <div class="col-lg-6">
                            <div class="row">
                    ...
                    <div class="navbar row">
                        <asp:GridView ID="gvWarningTypes" CssClass="table table-responsive" runat="server" AllowSorting="true"
                            AllowPaging="True" PageSize="10" OnPageIndexChanged="gvWarningTypes_PageIndexChanged" OnPageIndexChanging="gvWarningTypes_PageIndexChanging" 
                            OnRowDataBound="gvWarningTypes_RowDataBound" OnSelectedIndexChanging="gvWarningTypes_SelectedIndexChanging" OnSelectedIndexChanged="gvWarningTypes_SelectedIndexChanged"
                            OnRowCommand="gvWarningTypes_RowCommand" OnRowCreated="gvWarningTypes_RowCreated" OnSorting="gvWarningTypes_Sorting">

                            <Columns>

                                <asp:BoundField DataField="WarningType.Code" HeaderText="<%$ Resources:lang, CodeString %>" ReadOnly="True"
                                    SortExpression="Supplier.Code" Visible="false" />
                                <asp:TemplateField HeaderText="<%$ Resources:lang, CodeString %>" SortExpression="WarningType.Code">
                                    <HeaderTemplate>
                                ...
                                <asp:TemplateField HeaderText="<%$ Resources:lang, DescriptionString %>" SortExpression="FirstName">
                                    ...
                                    <ItemTemplate>
                                      ...
                                      <asp:Panel ID="pnlExtraInformation" runat="server" style="border-top:1px solid; border-top-color:#428BCA" >
                                         <p></p>
                                          <asp:Label ID="lblExtraInformation" runat="server" Text='<%# string.Format("<p/>{0}: {1}<p/>{2}: {3}<p/>{4}: {5}<p/>{6}: {7}", this.GetGlobalResourceObject("lang", "SeverityString") as string,((WhereToBuy.entities.WarningType)Container.DataItem).Severity, 
                                                                                                                                                         this.GetGlobalResourceObject("lang", "NotesString") as string, ((WhereToBuy.entities.WarningType)Container.DataItem).Notes,
                                                                                                                                                         this.GetGlobalResourceObject("lang", "CreationString") as string, ((WhereToBuy.entities.WarningType)Container.DataItem).Creation,
                                                                                                                                                         this.GetGlobalResourceObject("lang", "VersionString") as string, ((WhereToBuy.entities.WarningType)Container.DataItem).Version)%>'>
                                        </asp:Label>
