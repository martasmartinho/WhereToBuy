<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SuppliersUC.ascx.cs" Inherits="WhereToBuy.web.UserControls.Suppliers.Suppliers.SuppliersUC" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <h2>
                                <asp:Label ID="lblTitle" CssClass="text-primary top-left" runat="server" Text="<%$ Resources:lang, SuppliersString %>"></asp:Label>
                            </h2>
                        </div>
                        <div class="col-lg-6">
                            <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-8 col-sm-8 col-lg-10">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-5">
                                        <h4>
                                            <asp:Label ID="lblName" runat="server" CssClass="text-muted" Text="<%$ Resources:lang, NameString %>"></asp:Label>
                                        </h4>
                    ...
                    <div class="navbar row">
                        <asp:GridView ID="gvSuppliers" CssClass="table table-responsive" runat="server" AllowSorting="true"
                            AllowPaging="True" PageSize="10" OnPageIndexChanged="gvSuppliers_PageIndexChanged" OnPageIndexChanging="gvSuppliers_PageIndexChanging" 
                            OnRowDataBound="gvSuppliers_RowDataBound" OnSelectedIndexChanging="gvSuppliers_SelectedIndexChanging" OnSelectedIndexChanged="gvSuppliers_SelectedIndexChanged"
                            OnRowCommand="gvSuppliers_RowCommand" OnRowCreated="gvSuppliers_RowCreated" OnSorting="gvSuppliers_Sorting">

                            <Columns>

                                <asp:BoundField DataField="Supplier.Code" HeaderText="<%$ Resources:lang, CodeString %>" ReadOnly="True"
                                    SortExpression="Supplier.Code" Visible="false" />
                                <asp:TemplateField HeaderText="<%$ Resources:lang, CodeString %>" SortExpression="Supplier.Code">
                                    <HeaderTemplate>
                                ...
                                <asp:TemplateField HeaderText="<%$ Resources:lang, NameString %>" SortExpression="FirstName">
                                    <HeaderTemplate>
                                        <asp:LinkButton runat="server" ID="lnkName" CommandName="Sort" CommandArgument="Descricao" CssClass="btn-link text-muted" Font-Bold="true" Text="<%$ Resources:lang, NameString %>">Name</asp:LinkButton>
                                    </HeaderTemplate>
                                    ...
                                    <ItemTemplate>
                                      ...
                                      <asp:Panel ID="pnlExtraInformation" runat="server" style="border-top:1px solid; border-top-color:#428BCA" >
                                         <p></p>
                                          <asp:Label ID="lblExtraInformation" runat="server" Text='<%# string.Format("<p/>({0})<p/>{1}: {2}<p/>{3}: {4}<p/>{5}: {6}<p/>{7}: {8}", this.GetGlobalResourceObject("lang", "SalesmanDataString") as string,
                                                                                                                                                         this.GetGlobalResourceObject("lang", "NameString") as string,((WhereToBuy.entities.Supplier)Container.DataItem).Salesman,
                                                                                                                                                         this.GetGlobalResourceObject("lang", "PhoneString") as string, ((WhereToBuy.entities.Supplier)Container.DataItem).Phone,
                                                                                                                                                         this.GetGlobalResourceObject("lang", "EmailString") as string, ((WhereToBuy.entities.Supplier)Container.DataItem).Email,
                                                                                                                                                         this.GetGlobalResourceObject("lang", "OnlineActiveAccessString") as string, ((WhereToBuy.entities.Supplier)Container.DataItem).ActiveOnlineAccess)%>'>
                                        </asp:Label>
                                    ...
                                    <ItemTemplate>
                                        <div>
                                            <div class="col-lg-5">
                                             ...
                                             <div class="col-lg-5">
                                                 <asp:LinkButton ID="lnkSelect" runat="server" CommandName="Select" style="display:none" ToolTip="<%$ Resources:lang, SelectString %>"><span class="glyphicon glyphicon-open"></asp:LinkButton>
