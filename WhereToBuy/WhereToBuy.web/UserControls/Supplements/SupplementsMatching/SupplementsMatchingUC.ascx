<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SupplementsMatchingUC.ascx.cs" Inherits="WhereToBuy.web.UserControls.Supplements.SupplementsMatching.SupplementsMatchingUC" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <h2>
                                <asp:Label ID="lblTitle" CssClass="text-primary top-left" runat="server" Text="<%$ Resources:lang, SupplementsMatchingString %>"></asp:Label>
                            </h2>
                        </div>
                        <div class="col-lg-6">
                            <div class="row">
                    ...
                    <div class="navbar row">
                        <asp:GridView ID="gvSupplementsMatching" CssClass="table table-responsive" runat="server" AllowSorting="true"
                            AllowPaging="True" PageSize="10" OnPageIndexChanged="gvSupplementsMatching_PageIndexChanged" OnPageIndexChanging="gvSupplementsMatching_PageIndexChanging"
                            OnRowDataBound="gvSupplementsMatching_RowDataBound"
                            OnRowCommand="gvSupplementsMatching_RowCommand" OnRowCreated="gvSupplementsMatching_RowCreated" OnSorting="gvSupplementsMatching_Sorting">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="<%$ Resources:lang, SupplierString %>" SortExpression="Supplier.Name">
                                    ...
                                    <ItemTemplate>
                                        <div>
                                            <asp:Label ID="SupplierLabel" runat="server" Text='<%# string.Format("{0}<p/>{1}",((WhereToBuy.entities.SupplementMatching)Container.DataItem).Supplier.Code, 
                                                                                                                                                        ((WhereToBuy.entities.SupplementMatching)Container.DataItem).Supplier.Name )%>'>
                                            </asp:Label>
                                        </div>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Code/Description" SortExpression="FirstName">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblCode" runat="server" Text='<%# string.Format("{0}<p/>{1}",((WhereToBuy.entities.SupplementMatching)Container.DataItem).Code, 
                                                                                                                                                        ((WhereToBuy.entities.SupplementMatching)Container.DataItem).Description)%>'>
                                        </asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle Width="25%" HorizontalAlign="Left" VerticalAlign="Top" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Supplement" SortExpression="SupplementDescription">
                                    <HeaderTemplate>
                                        <asp:LinkButton runat="server" ID="lnkSupplement" CommandName="Sort" CommandArgument="MapTo" CssClass="btn-link" Font-Bold="true" Text="<%$ Resources:lang, SupplementString %>">Brand</asp:LinkButton>
                                    </HeaderTemplate>

                                    <ItemTemplate>
                                        <asp:Label ID="lblMapToCode" runat="server"
                                            Text='<%# ((WhereToBuy.entities.SupplementMatching)Container.DataItem).MapTo !=null ? string.Format("[{0}] {1}", ((WhereToBuy.entities.SupplementMatching)Container.DataItem).MapTo.Code,
                                                      ((WhereToBuy.entities.SupplementMatching)Container.DataItem).MapTo.Description) : string.Empty %>'></asp:Label>
                                    </ItemTemplate>
