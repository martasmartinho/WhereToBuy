<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StateMatchingUC.ascx.cs" Inherits="WhereToBuy.web.UserControls.States.StateMatching.StateMatchingUC" %>
...
<%@ Register Src="~/UserControls/States/StatesSelBox/StatesSelBox.ascx" TagPrefix="uc1" TagName="StatesSelBox" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <h2>
                                <asp:Label ID="TitleLabel" CssClass="text-primary top-left" runat="server" Text="<%$ Resources:lang, StateMatchingString %>"></asp:Label>
                            </h2>
                        </div>
                        <div class="col-lg-6">
                            <div class="row">
                        ...
                        <div class="col-xs-8 col-sm-8 col-lg-10">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-10">
                                    <div>
                                        <div class="form-group">
                                            <asp:Label ID="Label2" CssClass="control-label col-sm-2" runat="server" Text="<%$ Resources:lang, StateString %>"></asp:Label>
                                            <div class="col-sm-8">
                                                <uc1:StatesSelBox runat="server" ID="StatesSelBox" />
                                            </div>
                                            <div class="col-sm-2">
                                            </div>
                                        </div>
