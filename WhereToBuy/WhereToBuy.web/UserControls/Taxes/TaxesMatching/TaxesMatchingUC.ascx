<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TaxesMatchingUC.ascx.cs" Inherits="WhereToBuy.web.UserControls.Taxes.TaxesMatching.TaxesMatchingUC" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <h2>
                                <asp:Label ID="lblTitle" CssClass="text-primary top-left" runat="server" Text="<%$ Resources:lang, TaxesMatchingString %>"></asp:Label>
                            </h2>
                        </div>
                        <div class="col-lg-6">
                            <div class="row">
                    ...
                    <div class="navbar row">
                        <asp:GridView ID="gvTaxesMatching" CssClass="table table-responsive" runat="server" AllowSorting="true"
                            AllowPaging="True" PageSize="10" OnPageIndexChanged="gvTaxesMatching_PageIndexChanged" OnPageIndexChanging="gvTaxesMatching_PageIndexChanging"
                            OnRowDataBound="gvTaxesMatching_RowDataBound"
                            OnRowCommand="gvTaxesMatching_RowCommand" OnRowCreated="gvTaxesMatching_RowCreated" OnSorting="gvTaxesMatching_Sorting">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="<%$ Resources:lang, SupplierString %>" SortExpression="Supplier.Name">
                                    ...
                                    <ItemTemplate>
                                        <div>
                                            <asp:Label ID="SupplierLabel" runat="server" Text='<%# string.Format("{0}<p/>{1}",((WhereToBuy.entities.TaxMatching)Container.DataItem).Supplier.Code, 
                                                                                                                                                        ((WhereToBuy.entities.TaxMatching)Container.DataItem).Supplier.Name )%>'>
                                            </asp:Label>
                                        </div>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Code/Description" SortExpression="FirstName">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblCode" runat="server" Text='<%# string.Format("{0}<p/>{1}",((WhereToBuy.entities.TaxMatching)Container.DataItem).Code, 
                                                                                                                                                        ((WhereToBuy.entities.TaxMatching)Container.DataItem).Description)%>'>
                                        </asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle Width="25%" HorizontalAlign="Left" VerticalAlign="Top" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Tax" SortExpression="TaxDescription">
                                    <HeaderTemplate>
                                        <asp:LinkButton runat="server" ID="lnkTax" CommandName="Sort" CommandArgument="MapTo" CssClass="btn-link" Font-Bold="true" Text="<%$ Resources:lang, TaxString %>">Brand</asp:LinkButton>
                                    </HeaderTemplate>

                                    <ItemTemplate>
                                        <asp:Label ID="lblMapToCode" runat="server"
                                            Text='<%# ((WhereToBuy.entities.TaxMatching)Container.DataItem).MapTo !=null ? string.Format("[{0}] {1}", ((WhereToBuy.entities.TaxMatching)Container.DataItem).MapTo.Code,
                                                      ((WhereToBuy.entities.TaxMatching)Container.DataItem).MapTo.Description) : string.Empty %>'></asp:Label>
                                    </ItemTemplate>
