<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TaxMatchingUC.ascx.cs" Inherits="WhereToBuy.web.UserControls.Taxes.TaxMatching.TaxMatchingUC" %>
...
<%@ Register Src="~/UserControls/Taxes/TaxSelBox/TaxSelBox.ascx" TagPrefix="uc2" TagName="TaxSelBox" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <h2>
                                <asp:Label ID="TitleLabel" CssClass="text-primary top-left" runat="server" Text="<%$ Resources:lang, TaxMatchingString %>"></asp:Label>
                            </h2>
                        </div>
                        <div class="col-lg-6">
                            <div class="row">
                        ...
                        <div class="col-xs-8 col-sm-8 col-lg-10">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-10">
                                    <div>
                                        <div class="form-group">
                                            <asp:Label ID="Label2" CssClass="control-label col-sm-2" runat="server" Text="<%$ Resources:lang, TaxString %>"></asp:Label>
                                            <div class="col-sm-8">
                                                <uc2:TaxSelBox runat="server" ID="TaxSelBox" />
                                            </div>
                                            <div class="col-sm-2">
                                            </div>
                                        </div>
