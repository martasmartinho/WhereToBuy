<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TaxesUC.ascx.cs" Inherits="WhereToBuy.web.UserControls.Taxes.Taxes.TaxesUC" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <h2>
                                <asp:Label ID="lblTitle" CssClass="text-primary top-left" runat="server" Text="<%$ Resources:lang, TaxesString %>"></asp:Label>
                            </h2>
                        </div>
                        <div class="col-lg-6">
                            <div class="row">
                    ...
                    <div class="navbar row">
                        <asp:GridView ID="gvTaxes" CssClass="table table-responsive" runat="server" AllowSorting="true"
                            AllowPaging="True" PageSize="10" OnPageIndexChanged="gvTaxes_PageIndexChanged" OnPageIndexChanging="gvTaxes_PageIndexChanging" 
                            OnRowDataBound="gvTaxes_RowDataBound" OnSelectedIndexChanging="gvTaxes_SelectedIndexChanging" OnSelectedIndexChanged="gvTaxes_SelectedIndexChanged"
                            OnRowCommand="gvTaxes_RowCommand" OnRowCreated="gvTaxes_RowCreated" OnSorting="gvTaxes_Sorting">

                            <Columns>

                                <asp:BoundField DataField="Tax.Code" HeaderText="<%$ Resources:lang, CodeString %>" ReadOnly="True"
                                    SortExpression="Supplier.Code" Visible="false" />
                                <asp:TemplateField HeaderText="<%$ Resources:lang, CodeString %>" SortExpression="Tax.Code">
                                    <HeaderTemplate>
                                ...
                                <asp:TemplateField HeaderText="<%$ Resources:lang, DescriptionString %>" SortExpression="FirstName">
                                    ...
                                    <ItemTemplate>
                                      ...
                                      <asp:Panel ID="pnlExtraInformation" runat="server" style="border-top:1px solid; border-top-color:#428BCA" >
                                         <p></p>
                                          <asp:Label ID="lblExtraInformation" runat="server" Text='<%# string.Format("<p/>{0}: {1}<p/>{2}: {3}<p/>{4}: {5}<p/>{6}: {7}", this.GetGlobalResourceObject("lang", "TaxDesignationString") as string,((WhereToBuy.entities.Tax)Container.DataItem).TaxDesignation, 
                                                                                                                                                         this.GetGlobalResourceObject("lang", "TaxRateString") as string, ((WhereToBuy.entities.Tax)Container.DataItem).TaxValue,
                                                                                                                                                         this.GetGlobalResourceObject("lang", "CreationString") as string, ((WhereToBuy.entities.Tax)Container.DataItem).Creation,
                                                                                                                                                         this.GetGlobalResourceObject("lang", "VersionString") as string, ((WhereToBuy.entities.Tax)Container.DataItem).Version)%>'>
                                        </asp:Label>
