<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TaxUC.ascx.cs" Inherits="WhereToBuy.web.UserControls.Taxes.Tax.TaxUC" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        ...
        <script type="text/javascript">
            ...
            Sys.Application.add_load(function () {
                $(document).ready(function () {
                    var taxPanel = '#' + '<%= pnlTax.ClientID %>';

                    $(taxPanel + ' .spinner .btn:first-of-type').on('click', function () {
                        $(taxPanel +' .spinner input').val((parseFloat($(taxPanel + ' .spinner input').val()) + 0.10).toFixed(2));

                    });
                    $(taxPanel + ' .spinner .btn:last-of-type').on('click', function () {

                        if (parseFloat($(taxPanel + ' .spinner input').val()) > 0) {
                            $(taxPanel + ' .spinner input').val((($(taxPanel + ' .spinner input').val()) - 0.10).toFixed(2));
                        }
        ...
        <Panel ID="pnlTax" runat="server" class="container-fluid">
            ...
            <div class="col-lg-10">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <h2>
                            <asp:Label ID="lblTitle" CssClass="text-primary top-left" runat="server" Text="<%$ Resources:lang, TaxString %>"></asp:Label>
                        </h2>
                    </div>
                            ...
                            <div class="col-lg-10">
                                ...
                                <div >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:Label runat="server" CssClass="control-label col-sm-2" Text="<%$ Resources:lang, TaxDesignationString %>"></asp:Label>

                                        <div class="col-sm-10">
                                            <asp:TextBox ID="txtTaxDesignation" runat="server" CssClass="form-control" />
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:Label ID="Label4" runat="server" CssClass="control-label col-sm-2" Text="<%$ Resources:lang, TaxValueString %>"></asp:Label>

                                        <div class="col-sm-10">

                                            <div class="input-group spinner">

                                                <asp:TextBox ID="txtTaxRate" runat="server" Enabled="false" CssClass="form-control" />
