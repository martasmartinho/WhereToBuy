<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StocksMatchingUC.ascx.cs" Inherits="WhereToBuy.web.UserControls.Stocks.StocksMatching.StocksMatchingUC" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <h2>
                                <asp:Label ID="lblTitle" CssClass="text-primary top-left" runat="server" Text="<%$ Resources:lang, StocksMatchingString %>"></asp:Label>
                            </h2>
                        </div>
                        <div class="col-lg-6">
                            <div class="row">
                    ...
                    <div class="navbar row">
                        <asp:GridView ID="gvStocksMatching" CssClass="table table-responsive" runat="server" AllowSorting="true"
                            AllowPaging="True" PageSize="10" OnPageIndexChanged="gvStocksMatching_PageIndexChanged" OnPageIndexChanging="gvStocksMatching_PageIndexChanging"
                            OnRowDataBound="gvStocksMatching_RowDataBound"
                            OnRowCommand="gvStocksMatching_RowCommand" OnRowCreated="gvStocksMatching_RowCreated" OnSorting="gvStocksMatching_Sorting">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="<%$ Resources:lang, SupplierString %>" SortExpression="Supplier.Name">
                                    ...
                                    <ItemTemplate>
                                        <div>
                                            <asp:Label ID="SupplierLabel" runat="server" Text='<%# string.Format("{0}<p/>{1}",((WhereToBuy.entities.StockMatching)Container.DataItem).Supplier.Code, 
                                                                                                                                                        ((WhereToBuy.entities.StockMatching)Container.DataItem).Supplier.Name )%>'>
                                            </asp:Label>
                                        </div>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="Code/Description" SortExpression="FirstName">
                                    ...
                                    <ItemTemplate>
                                        <asp:Label ID="lblCode" runat="server" Text='<%# string.Format("{0}<p/>{1}",((WhereToBuy.entities.StockMatching)Container.DataItem).Code, 
                                                                                                                                                        ((WhereToBuy.entities.StockMatching)Container.DataItem).Description)%>'>
                                        </asp:Label>
                                    </ItemTemplate>
                                    <ItemStyle Width="25%" HorizontalAlign="Left" VerticalAlign="Top" />
                                </asp:TemplateField>
                                <asp:TemplateField HeaderText="Stock" SortExpression="StockDescription">
                                    <HeaderTemplate>
                                        <asp:LinkButton runat="server" ID="lnkStock" CommandName="Sort" CommandArgument="MapTo" CssClass="btn-link" Font-Bold="true" Text="<%$ Resources:lang, StockString %>">Brand</asp:LinkButton>
                                    </HeaderTemplate>

                                    <ItemTemplate>
                                        <asp:Label ID="lblMapToCode" runat="server"
                                            Text='<%# ((WhereToBuy.entities.StockMatching)Container.DataItem).MapTo !=null ? string.Format("[{0}] {1}", ((WhereToBuy.entities.StockMatching)Container.DataItem).MapTo.Code,
                                                      ((WhereToBuy.entities.StockMatching)Container.DataItem).MapTo.Description) : string.Empty %>'></asp:Label>
                                    </ItemTemplate>
