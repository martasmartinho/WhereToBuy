<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StockUC.ascx.cs" Inherits="WhereToBuy.web.UserControls.Stocks.Stock.StockUC" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        ...
        <script type="text/javascript">
            ...
            Sys.Application.add_load(function () {
                $(document).ready(function () {
                    var stockPanel = '#' + '<%= pnlStock.ClientID %>';

                    $(stockPanel + ' .spinner .btn:first-of-type').on('click', function () {
                        if (parseInt($(stockPanel + ' .spinner input').val()) < 5) {
                            $(stockPanel + ' .spinner input').val((parseInt($(stockPanel + ' .spinner input').val()) + 1));
                        }
                        
                    });

                    $(stockPanel + ' .spinner .btn:last-of-type').on('click', function () {

                        if (parseInt($(stockPanel + ' .spinner input').val()) > -5 ) {
                            $(stockPanel + ' .spinner input').val((($(stockPanel + ' .spinner input').val()) - 1));
                        }
        ...
        <panel id="pnlStock" runat="server" class="container-fluid">
            ...
            <div class="col-lg-10">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <h2>
                            <asp:Label ID="lblTitle" CssClass="text-primary top-left" runat="server" Text="<%$ Resources:lang, StockString %>"></asp:Label>
                        </h2>
                    </div>
                            ...
                            <div class="col-lg-10">
                                ...
                                <div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:Label runat="server" CssClass="control-label col-sm-2" Text="<%$ Resources:lang, AvailabilityLevelString %>"></asp:Label>

                                        <div class="col-sm-10">
                                            
                                            <div class="input-group spinner">
                                                <asp:TextBox ID="txtAvailabilityLevel" runat="server" type="text" CssClass="form-control" Enabled="false" />
                                    ...
                                    <div class="form-group">
                                         ...
                                         <asp:Label runat="server" CssClass="control-label col-sm-2" Text="<%$ Resources:lang, StockCodeExpirationP50String %>"></asp:Label>

                                        <div class="col-sm-10">
                                            <uc1:StocksSelBox runat="server" id="StocksP50SelBox" />
                                        </div>
                                    ...
                                    <div class="form-group">
                                         ...
                                         <asp:Label runat="server" CssClass="control-label col-sm-2" Text="<%$ Resources:lang, StockCodeExpirationP60String %>"></asp:Label>

                                        <div class="col-sm-10">
                                           <uc1:StocksSelBox runat="server" id="StocksP60SelBox" />
                                        </div>
                                    ...
                                    <div class="form-group">
                                         ...
                                         <asp:Label runat="server" CssClass="control-label col-sm-2" Text="<%$ Resources:lang, StockCodeExpirationP70String %>"></asp:Label>

                                        <div class="col-sm-10">
                                            <uc1:StocksSelBox runat="server" id="StocksP70SelBox" />
                                        </div>
                                    ...
                                    <div class="form-group">
                                         ...
                                         <asp:Label runat="server" CssClass="control-label col-sm-2" Text="<%$ Resources:lang, StockCodeExpirationP80String %>"></asp:Label>

                                        <div class="col-sm-10">
                                            <uc1:StocksSelBox runat="server" id="StocksP80SelBox" />
                                        </div>
                                    ...
                                    <div class="form-group">
                                         ...
                                         <asp:Label runat="server" CssClass="control-label col-sm-2" Text="<%$ Resources:lang, StockCodeExpirationP90String %>"></asp:Label>

                                        <div class="col-sm-10">
                                            <uc1:StocksSelBox runat="server" id="StocksP90SelBox" />
                                        </div>
