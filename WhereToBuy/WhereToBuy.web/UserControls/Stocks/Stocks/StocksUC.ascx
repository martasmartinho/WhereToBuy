<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StocksUC.ascx.cs" Inherits="WhereToBuy.web.UserControls.Stocks.Stocks.StocksUC" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <h2>
                                <asp:Label ID="lblTitle" CssClass="text-primary top-left" runat="server" Text="<%$ Resources:lang, StocksString %>"></asp:Label>
                            </h2>
                        </div>
                        <div class="col-lg-6">
                            <div class="row">
                    ...
                    <div class="navbar row">
                        <asp:GridView ID="gvStocks" CssClass="table table-responsive" runat="server" AllowSorting="true"
                            AllowPaging="True" PageSize="10" OnPageIndexChanged="gvStocks_PageIndexChanged" OnPageIndexChanging="gvStocks_PageIndexChanging" 
                            OnRowDataBound="gvStocks_RowDataBound" OnSelectedIndexChanging="gvStocks_SelectedIndexChanging" OnSelectedIndexChanged="gvStocks_SelectedIndexChanged"
                            OnRowCommand="gvStocks_RowCommand" OnRowCreated="gvStocks_RowCreated" OnSorting="gvStocks_Sorting">

                            <Columns>

                                <asp:BoundField DataField="Stock.Code" HeaderText="<%$ Resources:lang, CodeString %>" ReadOnly="True"
                                    SortExpression="Supplier.Code" Visible="false" />
                                <asp:TemplateField HeaderText="<%$ Resources:lang, CodeString %>" SortExpression="Stock.Code">
                                    <HeaderTemplate>
                                ...
                                <asp:TemplateField HeaderText="<%$ Resources:lang, DescriptionString %>" SortExpression="FirstName">
                                    ...
                                    <ItemTemplate>
                                      ...
                                      <asp:Panel ID="pnlExtraInformation" runat="server" style="border-top:1px solid; border-top-color:#428BCA" >
                                         <p></p>
                                          <asp:Label ID="lblExtraInformation" runat="server" Text='<%# string.Format("<p/>{0}: {1}<p/>{2}: {3}<p/>{4}: {5}<p/>{6}: {7}<p/>{8}: {9}<p/>{10}: {11}<p/>{12}: {13}<p/>{14}: {15}", this.GetGlobalResourceObject("lang", "AvailabilityLevelString") as string,((WhereToBuy.entities.Stock)Container.DataItem).AvailabilityLevel, 
                                                                                                                                                         this.GetGlobalResourceObject("lang", "StockCodeExpirationP50String") as string, ((WhereToBuy.entities.Stock)Container.DataItem).StockCodeExpirationP50 == null ? "" :  ((WhereToBuy.entities.Stock)Container.DataItem).StockCodeExpirationP50.ToString(),
                                                                                                                                                         this.GetGlobalResourceObject("lang", "StockCodeExpirationP60String") as string, ((WhereToBuy.entities.Stock)Container.DataItem).StockCodeExpirationP60 == null ? "" :  ((WhereToBuy.entities.Stock)Container.DataItem).StockCodeExpirationP60.ToString(),
                                                                                                                                                         this.GetGlobalResourceObject("lang", "StockCodeExpirationP70String") as string, ((WhereToBuy.entities.Stock)Container.DataItem).StockCodeExpirationP70 == null ? "" :  ((WhereToBuy.entities.Stock)Container.DataItem).StockCodeExpirationP70.ToString(),
                                                                                                                                                         this.GetGlobalResourceObject("lang", "StockCodeExpirationP80String") as string, ((WhereToBuy.entities.Stock)Container.DataItem).StockCodeExpirationP80 == null ? "" :  ((WhereToBuy.entities.Stock)Container.DataItem).StockCodeExpirationP80.ToString(),
                                                                                                                                                         this.GetGlobalResourceObject("lang", "StockCodeExpirationP90String") as string, ((WhereToBuy.entities.Stock)Container.DataItem).StockCodeExpirationP90 == null ? "" :  ((WhereToBuy.entities.Stock)Container.DataItem).StockCodeExpirationP90.ToString(),
                                                                                                                                                         this.GetGlobalResourceObject("lang", "CreationString") as string, ((WhereToBuy.entities.Stock)Container.DataItem).Creation,
                                                                                                                                                         this.GetGlobalResourceObject("lang", "VersionString") as string, ((WhereToBuy.entities.Stock)Container.DataItem).Version)%>'>
                                        </asp:Label>
