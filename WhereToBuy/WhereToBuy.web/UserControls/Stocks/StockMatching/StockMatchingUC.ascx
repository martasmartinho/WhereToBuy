<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StockMatchingUC.ascx.cs" Inherits="WhereToBuy.web.UserControls.Stocks.StockMatching.StockMatchingUC" %>
<%@ Register Src="~/UserControls/MessageUC.ascx" TagPrefix="uc1" TagName="MessageUC" %>
<%@ Register Src="~/UserControls/Suppliers/SuppliersSelBox/SuppliersSelBox.ascx" TagPrefix="uc3" TagName="SuppliersSelBox" %>
<%@ Register Src="~/UserControls/Stocks/StocksSelBox/StocksSelBox.ascx" TagPrefix="uc2" TagName="StocksSelBox" %>
            ...
            <div class="row">
                ...
                <div class="col-lg-10">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <h2>
                                <asp:Label ID="TitleLabel" CssClass="text-primary top-left" runat="server" Text="<%$ Resources:lang, StockMatchingString %>"></asp:Label>
                            </h2>
                        </div>
                        <div class="col-lg-6">
                            <div class="row">
                        ...
                        <div class="col-xs-8 col-sm-8 col-lg-10">
                            ...
                            <div class="row">
                                ...
                                <div class="col-xs-8 col-sm-8 col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div  class="col-sm-10">
                                            <uc3:SuppliersSelBox runat="server" ID="SuppliersSelBox" />
                                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-10">
                                    <div >
                                        <div class="form-group">
                                            <asp:Label ID="Label2" CssClass="control-label col-sm-2" runat="server" Text="<%$ Resources:lang, StockString %>"></asp:Label>
                                            <div class="col-sm-8">
                                                <uc2:StocksSelBox runat="server" ID="StocksSelBox" />
                                            </div>
                                            <div class="col-sm-2">
                                            </div>
                                        </div>
